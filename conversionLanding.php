            ...
            <div class="tab-pane cls2" role="tabpanel" id="step6">
              ...
              <div class="card anyClass">
                            ...
                            <?php
                                    ...
                                    ?>
                                    <h6><a href="<?php echo base_url()."index.php/DeptConversion/document/".$attachment->name  ?>" class="red" target="_blank"><i class='fa fa-paperclip'></i>&nbsp;&nbsp;<?php echo $attachment->name;?> (Click to see the attachment)</a></h6>
                                    <?php 
...
var baseurl = "<?php echo base_url(); ?>";
    ...
    $('#approve_cases_to_ps_submit').on('click', () => {
        ...
        $.ajax({
            url: baseurl + "DeptConversion/approveConversionByJs",
        type: "post",
        dataType: "json",
    ...
    $('#final_approve_ps').on('click', () => {
        ...
        $.ajax({
            url: baseurl + "DeptConversion/finalOrderByPs",
        type: "post",
        dataType: "json",
        contentType: "application/json",
        success: function(data) {
    ...
    $('#revert_cases_to_dc_submit').on('click', () => {
        ...
        // console.log(caseData);return;
        $.ajax({
        url: baseurl + "DeptConversion/revertOrderByJs",
        type: "post",
        dataType: "json",
        contentType: "application/json",
        success: function(data) {
    ...
    $('#approveCasesByAst').click(function() {
        ...
        $.ajax({
            url: baseurl + "DeptConversion/verifyCasesByAssistant",
            type: 'POST',
            data: formData,
            dataType: "json",
            success: function(data) {
...
<script>
    ...
    function forward_to_js_from_aso()
    {
        ...
        alert(case_no);
            $.ajax({
            url: baseurl + "DeptConversion/sentConversionCasesFromASOtoJS",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
                if (data.responseType == 1) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            location.href = "<?=base_url('pending-conversion-cases')?>";
                            // location.reload(true);
