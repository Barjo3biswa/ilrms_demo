	...
	<div class="col-lg-10">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb p-3 text-white">
				...
				<li class="breadcrumb-item font-weight-bold"><a href="<?= base_url().'khatian-district-wise'?>">Khatian Info District Wise</a></li>
				<li class="breadcrumb-item font-weight-bold"><a href="<?= base_url().'khatian-circle-wise'.'/'.$khatianVillageWise[0]->district_code?>">Circle Wise Village khatian Info</a></li>
				<li class="breadcrumb-item font-weight-bold active" aria-current="page">
					Khatian Village Wise Info</li>
			</ol>
		</nav>
	</div>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb p-3 text-white">
				<li class="breadcrumb-item font-weight-bold">
					<a href="<?= base_url().'khatian-circle-wise'.'/'.$khatianVillageWise[0]->district_code?>">
...
<div class="p-2 bg-primary text-center text-white h5 shadow-sm border border-white rounded"><b>Khatian Info Village Wise</b>
</div>
	...
	<div class="tab-content">
		<div class="card-body">
			<table class="table table-hover text-center tab1">
				...
				<?php
				$i =1;
				foreach($khatianVillageWise as $key=>$row) :
					?>
					<tr>
						<td><?= $i++ ?></td>
						...
						<td><?= $row->pending_with_co_count ?></td>
						<td><?= $row->khatian_rayati_count ?></td>
					</tr>
				<?php endforeach; ?>
				</tbody>
			</table>
