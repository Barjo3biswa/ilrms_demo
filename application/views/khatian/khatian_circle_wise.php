		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb p-3 text-white">
				<li class="breadcrumb-item font-weight-bold">
					<a href="<?= base_url().'khatian-district-wise'?>">
...
<div class="p-2 bg-primary text-center text-white h5 shadow-sm border border-white rounded"><b>Khatian Info Circle Wise</b>
</div>
	...
	<div class="tab-content">
		<div class="card-body">
			<table class="table table-hover text-center tab1">
				...
				<?php
				$i =1;
				foreach($khatianCircleWise as $key=>$row) :
					?>
					<tr>
						<td><?= $i++ ?></td>
						...
						<td align="center">
							<a href="<?= base_url().'khatian-village-wise?dist_code='.$row->district_code.'&subdiv='.$row->subdiv_code.'&cir_code='.$row->cir_code?>">
