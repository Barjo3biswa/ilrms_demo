                    ...
                    <div class="reza-title" style="text-align: center;">
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align:justify;font-size:12px">
                                ...
                                <div class="col-12" style="text-align:justify;font-size:12px">
                                    <ul type="i">
                                        Under Mission Basundhara 2.0, several land-related cases remain unresolved due to the need for further clarification. 
                                        These pending cases are categorised district-wise and service-wise for a thorough review process to resolve outstanding
                                        issues by ensuring that all necessary information is gathered for appropriate decision-making. 
                                        This review service aims to streamline the settlement process.<br>
                                        In this regard, a total of <b style="color:red"><?=$total_prop;?></b>proposals were received from the District Commissioners, <b style="color:red"><?=$dist_name?></b> 
                                        districts for settlement of Khas and Ceiling Surplus land to indigenous, landless families under Mission Basundhara 3.0 
                                        for homestead purposes, out of which <b style="color:red"><?=$reverted_cases_count;?></b> (<b style="color:red"><?=$reverted_cases_count_text;?></b>) proposals have been reverted back, 
                                        while <b style="color:red"><?=$recomended_cases_count;?></b> proposals have been recommended by the department for placing before the cabinet after due verification/scrutiny.
                                        A list of the recommended proposals including details of the families alongwith the details of land, location, dag, zonal value, etc.
                                        has been prepared as per proposals received from the District Commissioner concerned and placed at Annexure-I.
                                        List for reverted cases are placed at Annexure-II.
                                    </ul>
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    3. BACKGROUND:
