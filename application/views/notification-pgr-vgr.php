    ...
    <div class="modal" role="dialog" id="generateNotificationModalVGR" data-keyboard="false">
...
<script type="text/javascript">
      $('#closeNotificationModal').on('click', function(){
        $('#generateNotificationModalVGR').hide('modal');
      });
  ...
  // final submit & generate PDF
    $(document).on("click",'#generatePDFnotification',function(){
        ...
        else
        {
            ...
            $.ajax({
                url: base_url + "CabController/SavePDFNotificationCopyVgr",
                type: "post",
                dataType: "json",
                data: {
