    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="reza-card">
        <div class="reza-title">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <span class="text-success">List of Final Approved CAB ID List</span>
            </div>
          ...
          <table class='table table-striped table-bordered' id='dataTableCab' width="100%">
            <thead>
              <tr>
                ...
                <th class="center"><label class="control-label">Notification No</th>
                <th class="center"><label class="control-label">Notification Digital Sign Date</th>
  ...
  $(document).ready( function () {
    ...
    function load_data(selectDistrict)
    {
      var table = $('#dataTableCab').DataTable({
        ...
        'ajax':{
          url: base_url+'index.php/CabController/getFinalApprovedCabIdListNC',
          type:'POST',
