...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    function load_data(selectDistrict)
    {
      var table = $('#dataTableCab').DataTable({
        ...
        'ajax':{
          url: base_url+'index.php/CabController/getCabIdByUserDistrictNC',
          type:'POST',
  ...
  function openModal(cab_id)
  {
    ...
    $.ajax({
      url: base_url + "CabController/getCasesByCabIdNC",
      type: "post",
      dataType: "json",
  ...
  $('#saveAndProcess').click(function(){
    ...
    if (selectedList.length > 0)
    {
      ...
      $.ajax({
        url: BASE_URL + "/CabController/toBeFinalizeSaveNC",
        type: "post",
        dataType: "json",
        contentType: "application/json",
        success: function (data) {
...
$(document).ready(function(){
  $('#generateMemoPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : base_url +'CabController/GenerateCabMemoNC', 
            data        : formData, 
            // dataType    : 'json', 
            encode      : true,
            success: function(data){
  ...
  // final submit & generate PDF
    $(document).on("click",'#generatePDFMemo',function(){
        ...
        else
        {
            ...
            $.ajax({
                url: base_url + "CabController/SavePDFMemoNC",
                type: "post",
                dataType: "json",
                data: {
