    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <span class="text-success">List of Final Approved Cases Under Cab ID : <?php echo $memo_name; ?>&nbsp;(<?php echo $cab_id; ?>)
                          </span>
                      </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        $('#select_meeting,#select_district').change(function(){
            ...
            load_data_cab_case_list(select_meeting,select_district);
        ...
        function load_data_cab_case_list(select_meeting,select_district) {
