        ...
        <div class="row">
            ...
            <div class="col-lg-12 " align="right">
                <div class="table-responsive">
                    ...
                    <table class="datatable table table-stripped" id='datatableTeaGrantCaseListForVerification'>
                        <thead >
                            <tr>
...
<script>
    ...
    {
        $('#datatableTeaGrantCaseListForVerification thead th:nth-of-type(2)').each(function () {
            var title = 'Case';
            $(this).html('<input type="text" class="input_search form-control form-control-sm" placeholder="Search ' + title + '" data-column-index="0" />');
        });

      var table = $('#datatableTeaGrantCaseListForVerification').DataTable({
        'pageLength': 10,
        "processing": true,
        "serverSide": true,
        "ordering"  : false,
        ...
        'ajax':{
        url: baseurl + "DeptTeaGrant/getPendingTeaGrantCaseListUnderAssistant",
          type:'POST',
          data: {
     ...
     $('.search_button').on('click', function() {
            ...
            $('#datatableTeaGrantCaseListForVerification').DataTable().destroy();
            load_tea_grant_datatable();
        });


        var selectedCheckBoxArray = [];
        $('#datatableTeaGrantCaseListForVerification tbody').on('click', 'input[type="checkbox"]', function(e) {
        ...
        $("#datatableTeaGrantCaseListForVerification").on('draw.dt', function() {
