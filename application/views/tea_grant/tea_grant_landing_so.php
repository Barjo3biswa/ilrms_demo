...
<!-- Modal for sent case for Verification SO -->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary btn-sm" id="confirmSentForVerificationToASO">Yes Sent to ASO</button>
            </div>
        </div>
    </div>
</div>
<!-- Modal for sent case for Verification SO End -->
...
<script>
    ...
    $('#dist_select_btn_submit').on('click', () => {
            ...
            $.ajax({
                url: baseurl + "DeptConversion/viewConversionCasesDptSo" ,
                type: "POST",
...
$(document).ready(function() {
    ...
    $(document).on('click', '#confirmSentForVerificationToASO', function() {
        var district_id = $("#selectDistrict").val();
