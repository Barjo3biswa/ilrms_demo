...
<div class="row" style='padding: 5px 20px 20px 0px'>
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="padding-left: 30px; margin-top: 15px">
        Ticket System /
        <a href="<?= base_url() . 'get-application' ?>">Application Type </a>
        / Details
    </div>
        ...
        <div class="reza-card">
            <div class="reza-title">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <span> Application Type (Ticket Management System)</span>
                    </div>
            ...
            <div class="reza-body"  style="margin-top: -30px!important;">
                <table class="table table-bordered table-striped">
                    <tbody>
                    <tr>
                        <th width="50%">Application Name</th>
                        <td width="50%"><?php echo $application->application_name; ?></td>
                    </tr>
                    <tr>
                        <th>Created By</th>
                ...
                <div class="row reza-title">
                    All Services Under <?php echo $application->application_name; ?>
                </div>
                <table class="table table-bordered table-striped ">
                    <thead>
                    <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Edit Application Type </h4>
            </div>
            <form id="form_validation" action="<?php echo base_url()?>update-application" method="POST">
                <div class="modal-body">
                    <input type="hidden" name="appId" value="<?php echo base64_encode($application->id); ?>" required>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label"> Application Type Name <span style="color:red;">*</span></label>
                                <input type="text" value="<?php echo $application->application_name; ?>" class="form-control" name="applicationTypeName" required maxlength="80" minlength="2">
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <div class="form-group form-float">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="fStatus"  style="width: 100%" name="status" required>
                                    <option  value="<?php echo $application->status?>" selected>
                                        <?php if($application->status==1) : ?>
                                            Active
                                        <?php else : ?>
                                            Inactive
