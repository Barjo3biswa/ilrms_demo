...
<div class="row rezaBody" style='padding: 10px 20px 20px 0px;'>
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="padding-left: 30px; margin-top: 15px">
        ...
        <?php if($ticket->ticket_status == TICKET_STATUS_PENDING && $ticket->a_status == 0) : ?>
            <a href="<?= base_url()?>pending-ticket-nic-man">
                Pending
            </a>
        <?php elseif($ticket->ticket_status == TICKET_STATUS_PENDING && $ticket->a_status == 1) : ?>
            <a href="<?= base_url()?>in-queue-ticket-nic-man">
                Assigned To Developer
            </a>
        <?php elseif($ticket->ticket_status == TICKET_STATUS_PENDING && $ticket->a_status == 2) : ?>
            <a href="<?= base_url()?>under-processing-ticket-nic-man">
                Request for Closed
            </a>
        <?php elseif($ticket->ticket_status == TICKET_STATUS_REJECTED) : ?>
            <a href="<?= base_url()?>rejected-ticket-nic-man">
                Rejected
            </a>
        <?php elseif($ticket->ticket_status == TICKET_STATUS_CLOSED) : ?>
            <a href="<?= base_url()?>closed-ticket-nic-man">
                Closed
            </a>
        <?php endif; ?>
        / Details
                                                ...
                                                <table class="table table-bordered">
                                                    ...
                                                    <?php if($assignedDev != ''): ?>
                                                        <tr>
                                                            ...
                                                            <td><b><?php echo $assignedDev->name ?> </b>( <?php echo $assignedDev->mobile_no ?> )</td>
                                                        </tr>
                                                        <tr>
                                                            <td>Assigned Date</td>
                                                            <td><?php echo date("d-m-Y", strtotime($ticket->assign_date ))?></td>
                                                        </tr>
                                                    <?php endif; ?>
