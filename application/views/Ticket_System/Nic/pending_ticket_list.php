...
<div class="row" style='padding: 5px 20px 20px 0px'>
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="padding-left: 30px; margin-top: 15px">
        ...
        <?php if($tType == TICKET_STATUS_PENDING) : ?>
            <a href="<?= base_url()?>pending-ticket-assign-man">
                Pending
            </a>
        <?php elseif($tType == TICKET_STATUS_ASSIGNED) : ?>
            <a href="<?= base_url()?>assign-ticket-to-dev">
                Assigned To Developer
            </a>
        <?php elseif($tType == TICKET_STATUS_REQUEST_TO_CLOSED) : ?>
            <a href="<?= base_url()?>request-for-closed">
                Request for Closed
            </a>
        <?php elseif($tType == TICKET_STATUS_REJECTED) : ?>
            <a href="<?= base_url()?>rejected-ticket-list">
                Rejected
            </a>
        <?php elseif($tType == TICKET_STATUS_CLOSED) : ?>
            <a href="<?= base_url()?>closed-ticket-list">
                Closed
            </a>
        <?php endif; ?>
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <?php $i= 0; foreach ($tickets as $ticket) :  $i++ ?>
                            <tr>
                                ...
                                <td class="center">
                                    <a class="btn btn-success" href="<?php echo base_url(); ?>index.php/TicketNicManController/getTechnicalTicketDetails/?app=<?php echo $ticket->ticket_id; ?>">
