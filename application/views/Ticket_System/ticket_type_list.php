            ...
            <div class="reza-title">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <span> Ticket Type (Ticket Management System)</span>
                    </div>
            ...
            <div class="reza-body" style="margin-top: -30px!important;">
                <table class="table table-bordered table-striped ">
                    ...
                    <?php foreach ($ticketTypes as $type): ?>
                        <tr>
                            <td><?php echo $i ?></td>
                            <td><?php echo $type->t_type_name ?></td>
                            <td>
                            ...
                            <td>
                                <!-- <a href="--><?php //echo base_url() ?><!--view-application-details/--><?php //echo base64_encode($application->id)?><!--"-->
...
<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_validation" action="<?php echo base_url()?>save-ticket-type" method="POST">
                <div class="modal-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label"> Ticket Type Name <span style="color:red;">*</span></label>
                                <input type="text" class="form-control" name="ticketTypeName" required maxlength="80" minlength="2">
                            </div>
                        </div>
                    </div>
                </div>
