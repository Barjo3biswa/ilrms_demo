...
<div class="row" style='padding: 5px 20px 20px 0px'>
    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" style="padding-left: 30px; margin-top: 15px">
        Ticket System / Application Type
    </div>
            ...
            <div class="reza-body"  style="margin-top: -30px!important;">
                <table class="table table-bordered table-striped">
                    ...
                    <?php foreach ($applications as $application): ?>
                        <tr>
                            <td><?php echo $i ?></td>
                            <td><?php echo $application->application_name ?></td>
                            <td>
                            ...
                            <td>
                                <a href="<?php echo base_url() ?>TicketSysCommonController/getApplicationDetailsPage/?app=<?php echo $application->id?>"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="defaultModalLabel">Add Application Type </h4>
            </div>
            <form id="form_validation" action="<?php echo base_url()?>save-application" method="POST">
                <div class="modal-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" >
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label"> Application Type Name <span style="color:red;">*</span></label>
                                <input type="text" class="form-control" name="applicationTypeName" required maxlength="80" minlength="2">
                            </div>
                        </div>
                    </div>
