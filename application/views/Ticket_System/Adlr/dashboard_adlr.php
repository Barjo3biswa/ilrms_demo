    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="row" style="padding-right: 10px">
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                <a href="<?= base_url() . 'register-ticket-for-adlr' ?>" target="_blank">
                    <div class="reza-card">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                <a href="<?= base_url() . 'closed-ticket-for-adlr' ?>" target="_blank">
                    <div class="reza-card">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                <a href="<?= base_url() . 'rejected-ticket-for-adlr' ?>" target="_blank">
                    <div class="reza-card">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                <a href="<?= base_url() . 'in-queue-ticket-for-adlr' ?>" target="_blank">
                    <div class="reza-card">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                <a href="<?= base_url() . 'under-processing-ticket-for-adlr' ?>" target="_blank">
                    <div class="reza-card">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                <a href="<?= base_url() . 'pending-ticket-for-adlr' ?>" target="_blank">
                    <div class="reza-card">
                    ...
                    <table class="table table-bordered table-striped ">
                        ...
                        <?php foreach ($services as $service): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url() ?>TicketSysReportController/getTicketServiceTypeWise/?service=<?php echo $service['id']?>"
