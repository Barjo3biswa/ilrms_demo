                    ...
                    <div class="container bg-white divCard pb3"  id="html5">
                        <div class="row mt-4" style=" margin-right: 50px; margin-left: 50px;font-size:14px">
                            <div class="col-lg-12" style="text-align:justify;font-size:14px">
                                Sub : <span style="margin-left: 40px;">Settlement of land in favor of indigenous, landless families of <b><?=$dist_name ?></b> District under Mission Basundhara 3.0 (SVAMITVA)</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row mt-4" style=" margin-right: 50px; margin-left: 50px;font-size:14px">
                            <div class="col-lg-12" style="text-align:justify;font-size:14px">
                                <span style="margin-left: 80px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    "basundhara.assam.gov.in" of Mission Basundhara 3.0 (SVAMITVA) for further necessary action at your
                                    end.
                                </span>
                            </div>
                        </div>
...
<script type="text/javascript">
  ...
  // final submit & generate PDF
    $(document).on("click",'#generatePDFnotificationSign',function(){
            ...
            $.ajax({
                url: BASE_URL + "CabController/SavePDFNotificationCopySignNc",
                type: "post",
                dataType: "json",
                data: {
    ...
    $(document)
        .ready(function(){
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : BASE_URL+ "NcSettlement/signedAndFinalApproveByDeptNc",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
