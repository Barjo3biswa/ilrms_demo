    ...
    <div class="reza-title">
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-2">
                <span>Pending Reclass Case List for <span class="text-danger"><?php echo $dist_name?></span>
                </span>
            </div>
            <div class="col-lg-12 " align="right">
                <div class="table-responsive">
                    <input type="hidden" name="dist_code" id="dist_code" value="<?=$dist_code?>">
                    <table class="datatable table table-stripped" id='dataTableReclassJDS'>
                        <thead >
                            <tr>
                                ...
                                <th class="text-white" width="15%">ADS Verify</th>
                                <th class="text-white" width="15%">JDS Verify</th>
...
<!--                     <button class="rezaButt buttdanger" id="bulkRevertToDcModalOpen">
                    ...
                    <button class="rezaButt buttsuccess" id="sentForVerificationDlr">
...
<script>
    ...
    function load_conversion_datatable()
    {
      ...
      var table = $('#dataTableReclassJDS').DataTable({
        ...
        'ajax':{
        url: baseurl + "ReclassificationSuiteSurvey/getPendingReclassCaseListDlr",
          type:'POST',
          data: {
     ...
     $('.search_button').on('click', function() {
            ...
            $('#dataTableReclassJDS').DataTable().destroy();
            load_conversion_datatable();
        });


        var selectedCheckBoxArray = [];
        $('#dataTableReclassJDS tbody').on('click', 'input[type="checkbox"]', function(e) {
        ...
        $("#dataTableReclassJDS").on('draw.dt', function() {
