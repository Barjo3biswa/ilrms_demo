...
<div class="p-2 bg-primary text-center text-white h5 shadow-sm border border-white rounded"><b>Zonal Dag Info District Wise</b>
</div>
	...
	<div class="tab-content">
		...
		<div class="card-body">
			...
			<table class="table table-hover text-center tab1" id="tab">
				...
				<?php
				$i=1;
				foreach($districtZonalDagCount as $key=>$row) :
					?>
					<tr>
						<td><?= $i++;?></td>
						...
						<td align="center">
							<a href="<?= base_url().'zonal-dag-circle-wise/'.$row->district_code?>">
