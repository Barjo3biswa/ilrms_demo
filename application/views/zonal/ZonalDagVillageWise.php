	...
	<div class="col-lg-10">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb p-3 text-white">
				<li class="breadcrumb-item font-weight-bold"><a href="<?= base_url().'zonal-dag-circle-wise'.'/'.$villageZonalDagCount[0]->district_code?>">Zonal Info</a></li>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb p-3 text-white">
				<li class="breadcrumb-item font-weight-bold">
					<a href="<?= base_url().'zonal-dag-circle-wise'.'/'.$villageZonalDagCount[0]->district_code?>">
		...
		<div class="card-body">
			<table class="table table-hover text-center tab1">
				...
				<tr style="background-color: #136a6f; color: #fff;">
					...
					<td width="10%">Approved Dags(s)</td>
				</tr>
				</thead>
				<tbody>
				<?php
				$i =1;
				foreach($villageZonalDagCount as $key=>$row) :
					?>
					<tr>
						<td><?= $i++ ?></td>
