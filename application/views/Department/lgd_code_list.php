				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="bg-white shadow-lg rounded p-2 card-info">
						...
						<div class="card-footer text-center">
                            <button type="button" id="lgd_code_exist_list_submit" class="rezaButt buttInfo" style="width: 320px">
                                <i class="fa fa-eye" aria-hidden="true"></i> Fetch List
                            </button>
						</div>
                            <div id="lgd_code_list_exist_div">
                            </div>
					</div>
				</div>
			</div>
...
$('#lgd_code_exist_list_submit').on('click', () => {
        ...
        $.ajax({
            url: baseurl + "AdlrReportController/viewLgdCodeListExistDetails" ,
            type: "POST",
            ...
            success: function(data) {
                $.unblockUI();
                $("#lgd_code_list_exist_div").html(data); 
            }
        });
});
