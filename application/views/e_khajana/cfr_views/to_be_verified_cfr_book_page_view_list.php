        ...
        <div class="card-body">
            ...
            <div class="card panel-heading text-warning bg-dark text-center" style="margin-top:-20px;">
                <h6 class="panel-title">
                    <u>
                        <b>NOTE:</b> AFTER VERIFICATION THE CFR PAGES WILL BE AVAILABE IN THE RESPECTIVE LIST (SUCCESS/ABORTED)
                    </u>                        
                </h6>
            </div> 
                ...
                <table id="ek_ast_pending_list_1" class="table table-hover text-center" style="width:100%">            
                    ...
                    <?php foreach ($viewData as $row):?> 
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url() . 'index.php/EkhajanaMouzadarCFRmanualResponse/verifyPayment/'.$row->department_id?>"
