...
<div class="container">
    ...
    <script src="<?php echo base_url('js/sweetalert2.all.min.js'); ?>"></script>
        ...
        <div id="displayBoxEK" style="display: none;"><img src="<?= base_url(); ?>/assets/process.gif" style="width: 80px;"></div>
            <u><h4 class="text-center mt-3 mb-5">**MOUZADAR'S PASSWORD RESET FORM**</h4></u>
            <form id="mouzadar_bank_details_form" action ="<?= base_url(); ?>/EkhajanaMouzadarController/fetchUserDetails" method="POST">
...
<script>
    ...
    function districtOnChange(){
        ...
        $.ajax({ 
            url: baseurl + "/EkhajanaMouzadarController/getSubdivNames",
            type: 'POST',
    ...
    const application = {
        ...
        $.ajax({ 
            url: baseurl + "/EkhajanaMouzadarController/getCirNames",
            type: 'POST',
            data: JSON.stringify(application),
            cache : false,
            processData: false,
    ...
    function circleOnChange(){
        ...
        $.ajax({ 
            url: baseurl + "/EkhajanaMouzadarController/getMouzaNames",
            type: 'POST',
            data: JSON.stringify(application),
            cache : false,
            processData: false,
