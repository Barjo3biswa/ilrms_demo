...
<div class="col-lg-10 offset-1">
    ...
    <table class="table table-hover table-bordered" style="width:100%!important;background-color:#e6e1e1;font-size:12px;!important" id="dist_cir_wise_table">
        ...
        <tbody class="text-center"> 
            <?php foreach ($distWiseDpFlag as $row):?>
                <tr>
                    <td><a href="<?php echo base_url() . 'index.php/EkhajanaDlrDashboard/getCircleWisedpFlagging/' . $row['dist_code'] ; ?>" title=""><?php echo $row['dist_name']; ?></a></td>
                    <?php
                        $patta_type_arr = [];
                        $flagged = [];
                        $unflagged = [];
