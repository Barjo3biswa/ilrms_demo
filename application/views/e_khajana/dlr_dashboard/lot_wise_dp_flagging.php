...
<div class="col-lg-10 offset-1">
    ...
    <table class="table table-hover table-bordered" style="width:100%!important;background-color:#e6e1e1;font-size:12px;!important" id="dist_cir_wise_table">
        ...
        <tr style="background-color:#b67eff;">
            ...
            <th class="text-center">Lot name</th>
        ...
        <tbody class="text-center"> 
            <?php foreach ($lotWiseDpFlag as $row):?>
            <tr>
                <td>
                    <a href="<?php echo base_url() . 'index.php/EkhajanaDlrDashboard/getVillWisedpFlagging/' .$row['dist_code'].'/'.$row['subdiv_code'].'/'.$row['cir_code'].'/'.$row['mouza_pargona_code'].'/'.$row['lot_no']; ?>" title=""><?php echo $row['lot_name']; ?></a>
                </td>
                <?php
                    $patta_type_arr = [];
                    $flagged = [];
