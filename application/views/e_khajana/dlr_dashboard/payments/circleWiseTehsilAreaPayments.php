<nav aria-label="breadcrumb">
    <ol class="breadcrumb p-3 text-white">
        <li class="breadcrumb-item font-weight-bold">
            <a href="<?php echo base_url(); ?>index.php/EkhajanaDlrDashboard/viewDistWiseTehsildariAreaPayments">
                District-Wise-eKhazana-Payment(Tehsildari-Area)
            </a>
        </li>
        <li class="breadcrumb-item font-weight-bold">
            <a href="#">
                Circle-Wise-eKhazana-Payment(Tehsildari-Area)
            </a>
        </li>         
    </ol>
</nav>
<div class="col-lg-10 mt-2 mb-3 offset-1" style="border:3px solid #96907e; border-radius:5px;">
    <div class="container bg-dark text-white p-1 shadow-lg ">
        <h5 style="text-align:center">Circle-Wise-eKhazana-Payment(Tehsildari-Area)</h5>
    </div>
    ...
    <table class="table table-hover table-bordered" style="border-color:black" id="mouz_dist_wise_table">
        ...
        <tbody>    
            <?php foreach ($getCircleWiseTotalAmountReceivedFromDistrict as $row):?>
