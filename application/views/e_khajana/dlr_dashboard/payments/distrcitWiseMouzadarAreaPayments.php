...
<div class="col-lg-10 mt-2 mb-3 offset-1" style="border:3px solid #96907e; border-radius:5px;">
    <div class="container bg-dark text-white p-1 shadow-lg ">
        <h5 style="text-align:center">District-Wise-eKhazana-Payment(Mouzadari-Area)</h5>
    </div>
    <div class="container bg-secondary text-white p-1 shadow-lg">
    <h6 style="text-align:center">Click The District To Get The Mouza Level Info</h6>
    </div>
    ...
    <table class="table table-hover table-bordered" style="border-color:black" id="mouz_dist_wise_table">
        ...
        <tbody>    
            <?php foreach ($getDistrcitWiseTotalAmountReceived as $row):?>
                <?php
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <a href="<?php echo base_url(); ?>index.php/EkhajanaDlrDashboard/viewMouzaWiseMouzdarAreaPayments/<?=$row['dist_code']?>">
                            <?=$row['district']?>
                        </a>                        
                    </td>
                    <td>
