...
<div class="panel panel-info panel-form ">
    <div class="card panel-heading text-white bg-secondary text-center">
        <h4 class="panel-title">
            <u>
                <b>E-Khajana-(Forwarded-List)</b><br>
            </u>                        
        </h4>
    </div>  
            ...
            <div class="card-body shadow-lg p-1 mb-5 bg-white rounded">                              
                <div class = "card-body">            
                    <table id="ek_ast_pending_list_1" class="table table-hover text-center" style="width:100%">            
                        ...
                        <tbody>
			            <?php foreach ($mouzadarForwardedCases as $row):?> 
				            <tr>
                                <td>
                                ...
                                <td>
                                    <a class="btn btn-success btn-sm text-white" 
                                        href="<?php echo base_url() . 'index.php/EkhajanaMouzadarController/viewForwardedListDetails/'.$row->id?>" role="button" style="font-size: 14px;">
                                        View Details &nbsp;&nbsp;
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
