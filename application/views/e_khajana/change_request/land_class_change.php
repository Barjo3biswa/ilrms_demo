                        ...
                        <div class="row mt-3">
                            <div class="col-lg-10">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-left">
                                        <select class="js-single js-states form-control" style="width: 85%" onchange="getLandclassdiv()" id="dag_nos" name="dag_nos">
                        ...
                        <div class="content-div" id="content-div"><br>
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr>
                                        <td><input type="hidden" id="class_code" name="class_code"><span class="landclass"></span></td>
                                        <td>
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event)
  {
    ...
    //console.log(formData);
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'EkhajanaMouzadarChangeRequestController/landclassPost', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
