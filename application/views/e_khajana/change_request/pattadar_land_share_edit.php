                        ...
                        <div class="row mt-3">
                            <div class="col-lg-10">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-left">
                                        <select class="js-single js-states form-control" style="width: 85%" onchange="getPattdarsonDag()" id="dag_nos" name="dag_nos">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered table-striped table-hover">
                                    ...
                                    <tr class="bg-info" style="background: #17a2b8 !important;text-align:center">
                                        <th colspan="7" style="color:white">Suggested Pattadar Land Share</th>
                                    </tr>
                                    </thead>
...
<script type="text/javascript">
  ...
  $('#formAjaxPost').on('submit', function(event)
  {
    ...
    //console.log(formData);
        $.ajax({
            type        : 'POST', 
            url         : baseurl+'EkhajanaMouzadarChangeRequestController/landAreaPost', 
            data        : formData, 
            dataType    : 'json', 
            encode      : true,
            beforeSend: function(){
