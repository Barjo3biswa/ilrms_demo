          ...
          <table class='table table-striped table-bordered' id='dataTableCab' width="100%">
            <thead>
              <tr>
                ...
                <th class="center"><label class="control-label">Service Type</th>
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    function load_data(selectDistrict)
    {
      var table = $('#dataTableCab').DataTable({
        ...
        'ajax':{
          url: base_url+'index.php/DeptMb3Cabinet/getCabIdByUserDistrictFinalApproval',
          type:'POST',
  ...
  $('#generateNotificationPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        ...
        $.ajax({
            type        : 'POST', 
            url         : base_url +'DeptMb3Cabinet/GenerateNotification', 
            data        : formData, 
            // dataType    : 'json', 
            encode      : true,
            success: function(data){
