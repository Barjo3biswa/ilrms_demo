    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="reza-card">
            <div class="reza-title">
                <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            MB 3.0 Services Cabinet List (To be Finalize)
                        </div>
                </div>
            ...
            <div class="reza-body" id="showBody">
                ...
                <table class='table table-striped table-bordered' id='dataTableToBeFinalizeMb3Cabinet' width="100%">
                    <thead>
                        <tr>
...
<div class="modal" role="dialog" id="mb3MemoModal" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form id="generateMemoPost">
            ...
            <div class="modal-footer">
            <button type="submit" name="submit" class="btn btn-primary btn-sm">Generate Cab Memo</button>
            <button type="button" class="btn btn-secondary btn-sm" id="closeModalMemo">Close</button>
          </div>
          </form>
    </div>
  </div>
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    $('#selectDistrict').change(function(){
      ...
      $('#dataTableToBeFinalizeMb3Cabinet').DataTable().destroy();
      load_data(selectDistrict);
    });
    load_data();
    function load_data(selectDistrict)
    {
      var table = $('#dataTableToBeFinalizeMb3Cabinet').DataTable({
        'pageLength': 10,
        "processing": true,
        "serverSide": true,
        "ordering"  : false,
        ...
        'ajax':{
          url: base_url+'index.php/DeptMb3Cabinet/getTobeFinalizeMb3Cabinet',
          type:'POST',
  ...
  $('#dataTableToBeFinalizeMb3Cabinet tbody').on('click', 'input[type="checkbox"]', function(e) {
  ...
  $("#dataTableToBeFinalizeMb3Cabinet").on('draw.dt', function() {
...
<script type="text/javascript">
    ...
    var formData = $(this).serialize();
        $.ajax({
            ...
            url         : base_url +'DeptMb3Cabinet/GenerateCabMemoMb3', 
            data        : formData, 
            // dataType    : 'json', 
            encode      : true,
            success: function(data){
  ...
  // final submit & generate PDF
    $(document).on("click",'#generatePDFMemo',function(){
        ...
        else
        {
            ...
            $.ajax({
                url: base_url + "DeptMb3Cabinet/SavePDFMemoMb3",
                type: "post",
                dataType: "json",
                data: {
