                        ...
                        <div class="row">
                            <div class="col-12" style="text-align:justify;font-size:12px">
                                ...
                                <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                    One time conversion of Tea Grant Lands to Periodic Pattaunder Mission Basundhara 3.0 in town lands and peripheral areas.
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    2. INTRODUCTION :
                                </div>
                                <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                    This is regarding one time conversion of Tea Grant Lands to Periodic Patta in town lands and peripheral areas under Mission Basundhara3.0 in favour of	<b style="color:red"><?= $total_prop; ?></b> nos of Bonafide transferees of the State
                                    residing in <b style="color:red"> <?=$dist_name?> </b> Districts. A list of these transferees along with the details of location, patta, deed number, dag etc. has been prepared as per proposals received from the District Commissioners concerned and placed at Annexure-A.
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    3. BACKGROUND:
                                </div>
                                <div class="col-12 mrigankaText">
                                    Proposals for one time conversion of Tea Grant Lands to Periodic Patta in town lands and peripheral areas under Mission Basundhara 3.0 have been received from <b style="color:red"> <?=$dist_name?> </b> Districts recommended by the concerned District Commissioners.
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    4. PROPOSAL:
                                </div>
                                <div class="col-12" style="text-align:justify;font-size:12px">
                                        <ol type="i">
                                            <li>
                                                Total of <b style="color:red"><?= $total_prop; ?></b> ( <b style="color:red"><?=$total_individual_text?></b>) proposals received from <b style="color:red"> <?=$dist_count?> </b> Districts .
                                            </li>
                                            <li>
                                                The applicants have accordingly submitted the applications in Mission Basundhara Portal along with necessary KYC, self-declaration, geotagged Photographs of their respective plots, age proof, etc.
                                            </li>
                                            <li>
                                                Recommended Proposals for One time conversion of Tea Grant Lands to Periodic Pattaunder Mission Basundhara 3.0 in town lands and peripheral areas have been received from District Commissioners concerned.
                                            </li>
                            ...
                            <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                ...
                                <div class="col-12" style="text-align:justify;font-size:12px">
                                    <ol type="i">
                                        <li>
                                            As per the Govt Notification eCF No.565802/I/777761/2024 Dated Dispur, the 20-10-2024, regarding declaration of services under Revenue & DM department as per provision of the Assam Right to Public Services Act, 2012, the eligibility criteria, documents required, procedure of disposal and the details of designated public servants are enlisted. Enclosed herewith in Annexure- B. 
                                        </li>
                                        <li>
                                            As per the Govt. Notification eCF No.565802/I/777772/2024 Dated.20-10-2024, a premium of 10% of the current zonal value is levied by the Government for one time conversion of tea periodic lands or tea grant lands in town lands or peripheral areas, transferred on or before 31st day of December 2022, into periodic patta and conferring landholder status to the bonafide transferee of such lands. Enclosed herewith in Annexure-C.
                                        </li>
                                    </ol>
                                </div>
                            </div>
                            ...
                            <div class="col-12" style="text-align:justify;font-size:12px">
                                    <ol type="i">
                                        <li>
                                            These proposals have been processed together under Mission Basundhara 3.0 keeping in mind the greater good and relief to the bonafide transferee of tea grants or lands in town lands or peripheral areas, transferred on or before 31.12.2022, whose land records remained ambiguous due to the non-existence of an enabling provision, incorporated subsequently by a legislation. Hence, a large nos. of families of the State will be benefited at one time besides improving the administrative efficiency 
                                        </li>
                                        <li>
                                            These proposals also entail associated accrued revenue collection for the State Exchequer.
                                        </li>
                                        <li>
                                            A drive mode of one time conversion of Tea Grant Lands to Periodic Patta under Mission Basundhara 3.0 in town lands and peripheral areas. facilitates public to obtain corrected land records which leads to availing various services like bank loans, mortgage, land sale etc and also leading to land record cleansing.
                                        </li>
                                    </ol>
                                </div> 
                            <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                            ...
                            <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                The <b style="color:red"><?= $total_prop; ?></b> Nos of proposals shall accrue incremental value amounting to Rs <b style="color:red"><?= $amount_rs; ?></b> to the
                                state exchequer through levy of premium at the rate of 10% of the current zonal value payable to the Government for one time conversion of tea periodic lands or tea grant lands transferred on or before 31st day of December 2022 into periodic patta and conferring landholder status to the Bonafide transferee of such lands in town lands and peripheral areas, 
                                as per the Govt Notification eCFNo.565802/I/777772/2024Dated.20-10-2024
                            ...
                            <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                Approval of the Cabinet is sought for conversion of Tea Grant Lands to Periodic Patta under Mission Basundhara 3.0 in town lands and peripheral areas in favour of <b style="color:red"><?= $total_prop; ?></b> bonafide transferees of such lands of the State residing in various Districts as placed at Annexure-D subject to payment of premium of 10% of the current zonal value. <br>
                            </div>  
