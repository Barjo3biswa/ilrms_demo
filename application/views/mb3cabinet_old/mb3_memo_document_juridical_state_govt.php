                ...
                <div class="row mt-3 text-center" style="text-align: center;">
                    ...
                    <div class="reza-title" style="text-align: center;">
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align:justify;font-size:12px">
                                ...
                                <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                    Allotment of land in favour of Projects/Infrastructure of State Government Departments under Mission Basundhara 3.0
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    2. INTRODUCTION :
                                </div>
                                <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                    This is regarding allotment of town land in favour of <b style="color:red"><?= $total_prop; ?></b> Projects/Infrastructure of State Government Departments in various Districts across the State of Assam. A list of such Projects/Infrastructuredepartment wise along with the details  of  land,  location,  dag,  area, purpose etc.  has  been prepared as per proposals received from the District Commissioners concerned and placed at Annexure-I
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    3. BACKGROUND:
                                </div>
                                <div class="col-12 mrigankaText">
                                    Proposals for allotment of town land in favour of varied Projects/Infrastructure of State Government Departments have  been  received  from  different Districts under Mission Basundhara 3.0 after recommendation of the concerned Land Advisory Committee (LAC).
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    4. PROPOSAL:
                                </div>
                                <div class="col-12" style="text-align:justify;font-size:12px">
                                    <ol type="i">
                                        ...
                                        <li>
                                            ii. The applicant entity/institution (relevant State Government Department) have accordingly submitted the applications in Mission Basundhara Portal along with project details, self-declaration, land & area details, etc.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            iv. Proposals for allotment of town land in favor of listed Projects/Infrastructure of State Government Departments have been recommended by Land Advisory Committee (LAC) and approved by concerned Gurdian Minister.
                                        </li>
                            ...
                            <div class="col-12" style="text-align:justify;font-size:12px">
                                <ol type="i">
                                    <li>
                                        i. Office memorandums No. ECF no.106184/2019/8 dtd 20/5/2019, ECF No 106184/2019/9 dtd 7/7/2021 delegates power to the District Commissioners to provide allotment to infrastructure projects under State Government Departments without prior approval of the Govt. after Land Advisory Committee recommendation, only in rural areas. Copies enclosed at Annexure II, Annexure III.
                                    </li>
                                    <li>
                                        ii. As per Govt. notification eCF No.565802/I/776018/2024 Dated 19-10-2024, the District Commissioners are authorized to allot Government land to different State Government Departments only for public purpose and in rural areas after recommendation of Land Advisory Committee. Copy enclosed at Annexure IV.                                
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12" style="text-align:justify;font-size:12px">
                            <ol type="i">
                                <li>
                                    i. These proposals have been processed together under Mission Basundhara 3.0 keeping in mind the greater benefit of the State & welfare of the citizens, as allotment of government land for such projects can promote social welfare ,community development, improve access to quality healthcare and education, industrial development, create employment opportunities etc in various sectors.                                    
                                </li>
                                <li>
                                    ii. These proposals also entail strategic allocation of government land which can attract public/private investments, stimulating economic growth and development.                                    
                                </li>
                                <li>
                                    iii. Allotment of land for such infrastructure projects , can improve the quality of life for citizens and enhance the state's competitiveness bringing governance closer to citizens across the State.
                                </li>
                                <li>
                                    iv. The LAC’s concerned have already recommended these proposals and submitted through the Deputy Commissioners for Government consideration.
                                </li>
                            </ol>
                        </div> 
                        <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                        ...
                        <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                           Approval of the Cabinet is sought for allowing allotment of Government land (town land) in favour of <b style="color:red"><?= $total_prop; ?></b> Projects/Infrastructure of State Government Departments in various Districts across the State of Assam as placed at Annexure-I.                                                            
                        </div>
