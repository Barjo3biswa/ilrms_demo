	...
	<div class="container pt-4" style="width:65%">
			<div class="row jumbotron box8">
				<div class="col-sm-12 mx-t3 mb-4">
					<h3 class="text-center text-info">User Information from Aadhaar</h3>
					<hr>
				</div>
				<!-- <div class="col-sm-4 form-group">
					<label for="w3review" style="font-weight: bold">District</label>
					<select class="form-control " aria-label="" name="district" id="district" required>
					...
					<span id="districtErr" class="red"></span>
				</div> -->
          	...
          	<div class="row">
          		...
          		<div class="form-check col-lg-4 col-md-4 col-sm-6 col-xs-12">
							...
							<div class="form-check col-lg-4 col-md-4 col-sm-6 col-xs-12">
							  ...
							  <label class="form-check-label" for="defaultCheck1">তিনিচুকীয়া ( Tinsukia )</label>
							</div>
        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">&nbsp;</div>
				...
				<div class="col-sm-4 form-group">
					<label for="w3review" style="font-weight: bold">Name in Aadhaar</label>
				...
				<div class="col-sm-4 form-group">
					<label for="w3review" style="font-weight: bold">Guardian Name in Aadhaar</label>
				...
				<div class="col-sm-8 form-group">
					...
					<input type="text" class="form-control" name="role" id="role" required value="SDLC" readonly>
				</div>

				<div class="col-sm-4 form-group">
					<label for="w3review" style="font-weight: bold">Display Name in Minute</label>
					<input type="text" class="form-control" name="display_name" 
					id="display_name" value="<?= $response->aadhaarDetail->name_eng ?>" required>
	...
	<script>
      ...
      $.each($("input[name='district_list']:checked"), function() {
          dist_array.push($(this).val());
			...
			$.ajax({
				url: BASE_URL + "save-aadhaar-auth-data",
				type: "post",
				dataType: "json",
