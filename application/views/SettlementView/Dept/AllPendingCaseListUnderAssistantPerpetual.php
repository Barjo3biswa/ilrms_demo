    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            ...
            <div class="reza-body">
                ...
                <form action="<?php echo base_url(); ?>index.php/BasundharaMb2Perpetual/getCasesListByDistrict" method="post">
    ...
    $(document).ready(function() {
        ...
        function load_data_cab_case_list(select_service,select_meeting,select_verify) {
            ...
            var table = $('#dataTableDeptByDist').DataTable({
                ...
                'ajax': {
                    url: BASE_URL+'index.php/BasundharaMb2Perpetual/getAllCasesUnderAssistant',
                    type: 'POST',
                    data: {
