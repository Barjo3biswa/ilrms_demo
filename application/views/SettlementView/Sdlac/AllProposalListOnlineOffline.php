    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            ...
            <div class="reza-body">
                ...
                <form action="<?php echo base_url(); ?>index.php/Basundhara/getAllProposalListUnderSdlacOnlineOffline" method="post">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <span>All Proposal List Under SDLAC
                        ...
                        <tbody>
                            ...
                            foreach ($proposals as $proposal) :  $i++ ?>
                                <tr>
                                    ...
                                    <td class="center">
                                        <span class="text-success"><i class='fa fa-calendar'></i> On <?php echo date('d-M-Y', strtotime($proposal->h_date)); ?></span>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-success btn-sm" target="_blank" href="<?php echo base_url(); ?>index.php/Basundhara/viewAllApplicationUnderProposalSdlac/?proposal=<?php echo $proposal->id; ?>&service_code=<?php echo $service_code; ?>">
