...
<!-- Area Details Begin -->
<?php if (isset($deleted_dags) && !empty($deleted_dags)) : ?>
<!-- <h5 class="bg-danger p-2 text-white shadow mt-2 text-center">
    Dag not Eligible (Removed by LM)
</h5> -->
...
foreach ($deleted_dags as $dag_details) {
...
?>
    <table class="table table-bordered">
        <tr>
            <th rowspan="5" style="vertical-align : middle;text-align:center;background-color:#dc3545 ; text-transform: rotate(270deg);">Deleted <i class="fa fa-trash" aria-hidden="true"></i></th>
        ...
        <tr>
            <th>Total Land Area in deleted Dag</th>
            <td>
        ...
        <?php if ($dag_details->home_b != '' && $dag_details->home_k != '' && $dag_details->home_k != '') : ?>
            ...
            <?php if ($settlement_basic['service_code'] != SETTLEMENT_SPECIAL_CULTIVATORS_ID) : ?>
                <!-- Homested Area -->
                <tr>
                    <th class="text-danger">Area for Settlement(Homestead)</th>
                    <td>
        ...
        <?php if ($dag_details->agri_b != '' && $dag_details->agri_k != '' && $dag_details->agri_lc != '') : ?>
            ...
            <?php if ($settlement_basic['service_code'] != SETTLEMENT_PGR_VGR_LAND_ID) : ?>
                <!-- Agri Area -->
                <tr>
                    <th class="text-danger">Area for Settlement (Agricultural)</th>
                    <td>
