    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span>Pending Offline Settlement Cases (Forwarded by DC)<span style="color:red;font-size: 14px;"> ( N.B: Please Select District Before Proceed )</span></span>
            </div>
            ...
            <div class="reza-body">
                ...
                <form action="<?php echo base_url(); ?>index.php/OfflineSettlement/getAllCasesListByDept" method="post">
...
<script>
    ...
    $(document).on('click', '#markAndRecommendedWithoutVerify', function() {
        ...
        $('.selectMark:checked').each(function(i) {
            ...
            $.ajax({
                url: BASE_URL + "/OfflineSettlement/addCasesToCabMemo",
                type: "POST",
                dataType: "json",
...
// Datatable
    ...
    $(document).ready(function() {
        ...
        function load_data_cab_case_list(select_service,select_meeting,select_verify,select_pull_request) {
            ...
            var table = $('#dataTableDeptByDist').DataTable({
                ...
                'ajax': {
                    url: BASE_URL+'index.php/OfflineSettlement/getAllCasesUnderDept',
                    type: 'POST',
                    data: {
    ...
    $(document).on('click', '#bulkSentForVerification', function() {
        ...
        var selectAssistant = $('#selectAssistant').val();
            ...
            // return;
            $.ajax({
                url: BASE_URL + "/OfflineSettlement/bulkSentForVerification",
                type: "POST",
                dataType: "json",
                contentType: "application/json",
                success: function(data) {
    ...
    $(document).on('click', '#bulkRevertToDcModalOpen', function() {
        ...
        if (selectedList.length > 0) {
            ...
            console.log(applicant);
                ...
                $.ajax({
                url: BASE_URL + "/OfflineSettlement/getRemarksDetailsRevertedCases",
                type: "POST",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    event.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $('#show-Img').show();
                $.ajax({
                    url: BASE_URL + "/OfflineSettlement/bulkRevertCasesToDC",
                    type: "POST",
                    data: formdata,
                    dataType: "json",
                    success: function(data) {
