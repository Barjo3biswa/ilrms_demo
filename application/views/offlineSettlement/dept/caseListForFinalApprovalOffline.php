                    ...
                    <table class='table table-striped table-bordered tablesorter  pageshowpage unicode'   width="100%">
                        ...
                        <?php $i = 0; foreach ($finalCases as $case):  $i++ ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $this->utilclass->getMeetingNameByMeetingIdOffline($case->dist_code, $case->meeting_id); ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" align="center">
                ...
                <span class="text-danger">N.B:  After Final approval, these cases would be available for DC final order</span>
                <br>
                <!-- <div class="row mt-3">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success"  id="finalSubmitByDeptYes">Final Approve</button>
...
function openFinalSubmitModal(cab_id){
    ...
    $.ajax({
        url: BASE_URL + "OfflineSettlement/getTotalNoCasesForFinalApproval",
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
...
function finalSubmit(cab_id) {
    Swal.fire({
        ...
        text: '*** After approval, these cases would be available for DC Final Order. Approval of these cases should be done only after approval of Cabinate Memo. Is your cabinate memo approved? ***',
        icon: 'warning',
    ...
    $(document).on('click', '#finalSubmitByDeptYes', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                    ...
                    $('#finalSubmit').hide();
                $.ajax({
                    url: BASE_URL + "/OfflineSettlement/bulkApproveCasesByDPT",
                    type: "POST",
                    dataType: "json",
 ...
 function digitalSignNotificationView(cab_id){
        // alert('hi');
                $.ajax({
                    type        : 'POST', 
                    url         : BASE_URL +'CabController/GenerateNotificationForSignOffline', 
                    data        : {cab_id:cab_id}, 
                    // dataType    : 'json', 
                    encode      : true,
                    success: function(data){
