    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
               <span>Pending Gramdan/Bhoodan Cases (Forwarded by DC)<span style="color:red;font-size: 14px;"> ( N.B: Please Select District Before Proceed )</span></span>
            </div>
            ...
            <div class="reza-body">
                ...
                <form action="<?php echo base_url(); ?>index.php/Bhoodan/getAllCasesListByDept" method="post">
                        ...
                        <thead>
                            <tr>
                                ...
                                <select class="form-control input_search" name="select_service" id="select_service" data-column-index="4">
                                    ...
                                    <option value="<?= BHOODAN_LAND_ID ?>" selected>
                                        Gramdan/Bhoodan</option>
...
<script>
    ...
    $(document).on('click', '#markAndRecommendedWithoutVerify', function() {
        ...
        $('.selectMark:checked').each(function(i) {
            ...
            $.ajax({
                url: BASE_URL + "/Bhoodan/addCasesToCabMemo",
                type: "POST",
                dataType: "json",
...
// Datatable
    ...
    $(document).ready(function() {
        ...
        function load_data_cab_case_list(select_service,select_meeting,select_verify,select_pull_request) {
            ...
            var table = $('#dataTableDeptByDist').DataTable({
                ...
                'ajax': {
                    url: BASE_URL+'index.php/Bhoodan/getAllCasesUnderDept',
                    type: 'POST',
                    data: {
    ...
    $(document).on('click', '#bulkSentForVerification', function() {
        ...
        var selectAssistant = $('#selectAssistant').val();
            ...
            // return;
            $.ajax({
                url: BASE_URL + "/Bhoodan/bulkSentForVerification",
                type: "POST",
                dataType: "json",
                contentType: "application/json",
                success: function(data) {
    ...
    $(document).on('click', '#bulkRevertToDcModalOpen', function() {
        ...
        if (selectedList.length > 0) {
            ...
            console.log(applicant);
                ...
                $.ajax({
                url: BASE_URL + "/Bhoodan/getRemarksDetailsRevertedCases",
                type: "POST",
                dataType: "json",
                contentType: "application/json",
                success: function (data) {
    ...
    event.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $('#show-Img').show();
                $.ajax({
                    url: BASE_URL + "/Bhoodan/bulkRevertCasesToDC",
                    type: "POST",
                    data: formdata,
                    dataType: "json",
                    success: function(data) {
