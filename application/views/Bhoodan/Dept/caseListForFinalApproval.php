...
function openFinalSubmitModal(cab_id){
    ...
    $.ajax({
        url: BASE_URL + "NcSettlement/getTotalNoCasesForFinalApproval",
        type: 'POST',
        data: formdata,
        dataType: 'json',
        success: function (data) {
...
function finalSubmit(cab_id) {
    ...
    $(document).on('click', '#finalSubmitByDeptYes', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                    ...
                    $('#finalSubmit').hide();
                $.ajax({
                    url: BASE_URL + "/NcSettlement/bulkApproveCasesByDPT",
                    type: "POST",
                    dataType: "json",
 ...
 function digitalSignNotificationView(cab_id){
        // alert('hi');
                $.ajax({
                    type        : 'POST', 
                    url         : BASE_URL +'CabController/GenerateNotificationForSignNc', 
                    data        : {cab_id:cab_id}, 
                    // dataType    : 'json', 
                    encode      : true,
                    success: function(data){
