              ...
              <div class="card anyClass">
                <div class="card-body lm-report">
                  ...
                  <!-- Appied scheme -->
                      <div class="row p-2 px-5">
                        <div class="col-md-6">
                          <label for="formGroupExampleInput"><strong><?= $sl_count++ ?>.</strong> Applied Under Scheme</label>
                        </div>
                        <div class="col-md-6">
                          <div class="form-check form-check-inline">
                            <strong class="text-primary">
                              <?php foreach (json_decode(APPLIED_SCHEME) as $scheme) {
                                if ($scheme->CODE == $lmnote->applied_scheme) {
                                  echo $scheme->NAME;
                                }
                              }
                              ?>
