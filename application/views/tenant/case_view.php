                        ...
                        <?php foreach($dhardocuments as $docs): ?>
                            <tr>
                                <th>
                                    ...
                                    <a target='download'
                                    href="<?php echo base_url()?>index.php/DeptTenant/viewDharitreeDocument?dist_code=<?=$basic['dist_code']?>&doc_id=<?=$docs->id?>"><i class="fa fa-paperclip"></i> <?=$docs->file_name;?>
                                        <?php if(isset($docs->dag_no)){ ?>
                                            <span class="alert-danger"><small> for Dag no: <strong><?=$docs->dag_no?></strong></small></span>
                                        <?php }?>
                                    </a>
...
<script>
    ...
    function forward_to_js_from_aso()
    {
        ...
        //alert(case_no);
            $.ajax({
            url: baseurl + "DeptTenant/sentTenantCasesFromASOtoJS",
            type: "POST",
            dataType: "json",
