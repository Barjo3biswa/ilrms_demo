    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span>Case List Of AP to PP Conversion(Forwarded From DC)</span>
...
<div class="modal" role="dialog" id="markVerificationModal" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="form-group">
                    <select class="form-control" id="asst_id" name="asst_id">
...
<script>
    ...
    $('#dist_select_btn_submit').on('click', () => {
            ...
            $.ajax({
                url: baseurl + "DeptConversionNew/viewConversionCases" ,
                type: "POST",
...
$(document).ready(function() {
    ...
    $(document).on('click', '#markAddCasesBtn', function() {
        ...
        if (selectedList.length > 0) {
            $.ajax({
                // url: baseurl + "DeptConversionNew/getCabMemos",
                ...
                success: function(data) {
                    ...
                    select.empty();
                    select.append('<option disabled selected>-------------Select Conversion Cab Memo----------------</option>');
                    if (data.message) {
    ...
    $(document).on('click', '#confirmAddCasesToMemo', function() {
        ...
        if (selectedList.length > 0) {
            ...
            $.ajax({
                // url: baseurl + "DeptConversionNew/addConversionCasesToCabMemo",
    ...
    $(document).on('click', '#sentForVerificationModal', function() {
        $('#markVerificationModal').modal('show');
    });

    $(document).on('click', '#bulkSentForVerification_to_aso', function() {
    ...
    $(document).on('click', '#confirmSentForVerificationSO', function() {
        ...
        if (selectedList.length > 0) {
            ...
            $.ajax({
                url: baseurl + "DeptConversionNew/sentConversionCasesForVerification",
                type: "POST",
                dataType: "json",
                contentType: "application/json",
                success: function(data) {
    ...
    $(document).on('click', '#confirmAddCasesToProposal', function() {
        ...
        if (selectedList.length > 0) {
            ...
            $.ajax({
                url: baseurl + "DeptConversionNew/addConversionCasesToProposal",
                type: "POST",
                dataType: "json",
                contentType: "application/json",
                success: function(data) {
    ...
    if (selectedList.length > 0) {
        ...
        $.ajax({
            url: baseurl + "DeptConversionNew/getAstRemarksDetailsRevertedCases",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            data: JSON.stringify(applicant),
