    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="reza-card">
            ...
            <div class="reza-body" id="showBody">
                    ...
                    <table class='table' id='dataTableFinalizedConversionCabinet' width="100%">
                        <thead>
                        <tr>
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    $('#selectDistrict').change(function(){
      ...
      $('#dataTableFinalizedConversionCabinet').DataTable().destroy();
      load_data(selectDistrict);
    });
    load_data();
    function load_data(selectDistrict)
    {
      var table = $('#dataTableFinalizedConversionCabinet').DataTable({
        'pageLength': 10,
        "processing": true,
        "serverSide": true,
        "ordering"  : false,
