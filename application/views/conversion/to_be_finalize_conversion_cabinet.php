    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="reza-card">
            <div class="reza-title">
                <div class="row">
                      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          Conversion Cabinet List (To be Finalize)
                      </div>
                </div>
            ...
            <div class="reza-body" id="showBody">
                    ...
                    <table class='table table-striped table-bordered' id='dataTableToBeFinalizeConversionCabinet' width="100%">
                        <thead>
                        <tr>
...
<div class="modal" role="dialog" id="conversionMemoModal" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    $('#selectDistrict').change(function(){
      ...
      $('#dataTableToBeFinalizeConversionCabinet').DataTable().destroy();
      load_data(selectDistrict);
    });
    load_data();
    function load_data(selectDistrict)
    {
      var table = $('#dataTableToBeFinalizeConversionCabinet').DataTable({
        'pageLength': 10,
        "processing": true,
        "serverSide": true,
        "ordering"  : false,
        ...
        'ajax':{
          url: base_url+'index.php/DeptConversion/getTobeFinalizeConversionCabinet',
          type:'POST',
  ...
  $('#dataTableToBeFinalizeConversionCabinet tbody').on('click', 'input[type="checkbox"]', function(e) {
  ...
  $("#dataTableToBeFinalizeConversionCabinet").on('draw.dt', function() {
  ...
  function openModalMemoVGR(cab_id){
    ...
    $('#conversionMemoModal').show('modal');
  }
...
<script type="text/javascript">
    ...
    var formData = $(this).serialize();
        $.ajax({
            ...
            url         : base_url +'DeptConversion/GenerateCabMemoConversion', 
            data        : formData, 
            // dataType    : 'json', 
            encode      : true,
            success: function(data){
  ...
  // final submit & generate PDF
    $(document).on("click",'#generatePDFMemo',function(){
        ...
        else
        {
            ...
            $.ajax({
                url: base_url + "DeptConversion/SavePDFMemoConversion",
                type: "post",
                dataType: "json",
                data: {
