    ...
    function alpineData() {
        return {
            ...
            getDags() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcJdsController/getDags',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
...
<div class="col-lg-12 col-md-12 p-2" x-data="alpineData()">
    <div class="row justify-content-center">
        <div class="col-lg-12">
            <div class="text-center p-2" style="font-size:18px; font-weight: bold; background-color: #ffc000">NC
                VILLAGE
            </div>
            <div class="row pt-2">
                <div class="col-lg-2">
                    ...
                    <select id="dist_code" class="form-control form-control-sm">
                        <option selected
                                value="<?= $locations->dist->dist_code ?>"><?= $locations->dist->loc_name ?></option>
                    </select>
                </div>
                <div class="col-lg-2">
                    ...
                    <select id="subdiv_code" class="form-control form-control-sm">
                        <option selected
                                value="<?= $locations->subdiv->subdiv_code ?>"><?= $locations->subdiv->loc_name ?></option>
                    </select>
                </div>
                <div class="col-lg-2">
                    ...
                    <select id="cir_code" class="form-control form-control-sm">
                        <option selected
                                value="<?= $locations->circle->cir_code ?>"><?= $locations->circle->loc_name ?></option>
                    </select>
                </div>
                <div class="col-lg-2">
                    ...
                    <select id="mouza_pargona_code" class="form-control form-control-sm">
                        <option selected
                                value="<?= $locations->mouza->mouza_pargona_code ?>"><?= $locations->mouza->loc_name ?></option>
                    </select>
                </div>
                <div class="col-lg-2">
                    <label for="">Lot</label>
                    <select id="lot_no" class="form-control form-control-sm">
                        <option selected
                                value="<?= $locations->lot->lot_no ?>"><?= $locations->lot->loc_name ?></option>
                    </select>
                </div>
                <div class="col-lg-2">
                    ...
                    <select id="vill_townprt_code" class="form-control form-control-sm">
                        <option selected
                                value="<?= $locations->village->vill_townprt_code ?>"><?= $locations->village->loc_name ?></option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="modal" id="modal_vill_dag_chitha" tabindex="-1" aria-labelledby="modal_vill_dag_chitha"
             aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div>
                            <iframe width='100%' height='500px;'
                                    src='<?= 'data:application/pdf;base64,' . $pdf ?>'></iframe>
                        </div>
                    </div>

                    <div class="modal-footer">
                        <button type="button" onclick="closeModal()" class="btn btn-danger" data-dismiss="modal"><i
