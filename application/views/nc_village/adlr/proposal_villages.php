    ...
    function alpineData() {
        return {
            ...
            signProposal() {
                ...
                var self = this;
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcAdlrController/saveProposalPdf',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
                    ...
                    success: function(data) {
                        ...
                        if (data != null || data != '') {
                            ...
                            self.loadPreviewForSign('<?= base_url() ?>index.php/nc_village/NcAdlrController/getProposalBase');
                        }
                    }
                });
            },
            ...
            storeSignedProposal(jsonData, sign_key) {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcAdlrController/storeSignedProposal',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
                ...
                $.confirm({
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function () {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcAdlrController/getProposalVillageWise',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                        ...
                        <tbody>
                            ...
                            <template x-for="(village,index) in villages">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village/NcAdlrController/getPendingVillage?application_no="+village.application_no+"&d="+village.dist_code target=" _blank">View <i class=" fa fa-eye"></i></a>
                                    </td>
                                </tr>
                            </template>
                    ...
                    <div class="mt-3" x-show="villages.length > 0">
                        <table class="table table-striped table-bordered">
                            ...
                            <th style="background-color: #136a6f; color: #fff">
                                ADLR Note <span class="text-danger">*</span>
                            </th>
                            </thead>
                            <tbody>
                            <tr>
                                <td><textarea class="form-control" x-model="dlr_note" placeholder="ADLR Note"></textarea></td>
                            </tr>
                            </tbody>
                        </table>
                        <table class="table table-striped table-bordered">
