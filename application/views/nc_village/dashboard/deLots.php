...
<div class="container-fluid">
    ...
    <section class="content ms-5 me-5">
        <h4 class="text-center">Lot Wise Data Entered Villages for <?=$dist_name?></h4>
        ...
        <div class="d-flex justify-content-between align-items-center" style="overflow-x:auto;">
            ...
            <table class="table table-bordered table-sm">
                ...
                <?php if (!empty($lots)): ?>
                    <?php foreach ($lots as $lot_no => $data): ?>
                        <tr>
                            <td>
                                <a href="<?=base_url('index.php/nc_village/NcDashboardController/getDataEnteredVillage') . '/' . $dist_code . '/' . $data['loc_name']['subdiv']['subdiv_code'] . '/' . $cir_code . '/' . $mouza_pargona_code . '/' . $lot_no?>" class='' title=""><?php echo trim($data['loc_name']['lot']['loc_name']); ?></a>
                            </td>
