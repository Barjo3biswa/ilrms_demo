...
<div class="container-fluid">
    ...
    <section class="content ms-5 me-5">
        <h4 class="text-center">District Wise Data Entered Villages</h4>
            ...
            <table class="table table-bordered table-sm">
                ...
                <?php  if (!empty($districts)): ?>
                    <?php foreach ($districts as $dist_code => $data): ?>
                        <tr>
                            <td>
                                <a href="<?=base_url('index.php/nc_village/NcDashboardController/getDataEnteredCircle') . '/' . $dist_code?>" class='' title=""><?php echo trim($data['loc_name']['dist']['loc_name']); ?></a>
                            </td>
