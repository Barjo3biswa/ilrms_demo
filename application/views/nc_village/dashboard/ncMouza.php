...
<div class="container-fluid">
    ...
    <h4 class="text-center">  <?php if ($type == 'verified_lm') {echo ('Mouza Wise Number of LM Verified NC Villages for ') . $dist_name;} else if ($type == 'certified_co') {echo ('Mouza Wise Number of CO Certified NC Villages for ') . $dist_name;} else if ($type == 'digi_signature_dc') {echo ('Mouza Wise Number of DC Certified NC Villages for ') . $dist_name;}?></h4>
                ...
                <?php if (!empty($mouzas)): ?>
                    <?php foreach ($mouzas as $data): ?>
                        <?php if ($data["count"] != 0): ?>
                            <tr>
                                <td>
                                    <a href="<?=base_url('index.php/nc_village/NcDashboardController/getNcLotsByStatus/') . $type . '/' . $data['dist_code'] . '/' . $data['subdiv_code'] . '/' . $data['cir_code'] . '/' . $data['mouza_pargona_code']?>" class='' title=""><?php echo trim($data['loc_name']); ?></a>
                                </td>
