    ...
    function alpineData() {
        return {
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcDepartController/getVillagesG',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            <div class="row pt-2">
                ...
                <div class="col-lg-2">
                    ...
                    <select x-model="filter_status" id="filter_status" class="form-control form-control-sm">
                        ...
                        <option value="C">Verified</option>
                    </select>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-hover table-sm table-bordered">
                        ...
                        <template x-for="(village,index) in villages">
                            <tr>
                                ...
                                <td>
                                    <b>
                                        <small class="text-warning" x-show="village.status == 'A'">Pending</small>
                                        <small class="text-success" x-show="village.status == 'C'">Verified</small>
                                    </b>
                                </td>
                                <td>
                                    <a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village/NcDepartController/getPendingVillage?application_no="+village.application_no+"&d="+village.dist_code>Proceed <i class=" fa fa-chevron-right"></i></a>
                                </td>
                            </tr>
                        </template>
