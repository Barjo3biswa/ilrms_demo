    ...
    function alpineData() {
        return {
            ...
            init() {
                ...
                var self = this;
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/getPendingVillageData',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            getDags() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/getDags',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            changeVill() {
                ...
                $.confirm({
                    title: 'Confirm',
                    content: 'Please confirm to change village name.',
                    type: 'green',
                    typeAnimated: true,
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/changeVill',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                                    ...
                                    success: function(data) {
                                        if (data.verified != 'Y') {
                                            ...
                                            $.confirm({
                                                title: 'Success',
                                                content: 'The village name has been successfully submitted.',
                                                type: 'green',
                                                typeAnimated: true,
                                                buttons: {
                                                    Ok: {
                ...
                $.confirm({
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/certifyVillage',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                ...
                $.confirm({
                    ...
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/revertVillage',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
            ...
            forwardVillageToJds()
            {
                ...
                $.confirm({
                    title: 'Confirm',
                    content: 'Please confirm to forward this village to JDS',
                    type: 'orange',
                    typeAnimated: true,
                    buttons: {
                        Confirm: {
                            ...
                            action: function() {
                                $.ajax({
                                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/forwardToJds',
                                    method: "POST",
                                    async: true,
                                    dataType: 'json',
                                    data: {
                                    ...
                                    success: function(data) {
                                        ...
                                        if (data.submitted == 'Y') {
                                            $.confirm({
                                                title: 'Success',
                                                content: 'The Chitha and map of this village have been successfully forwarded to JDS.',
                                                type: 'green',
                                                typeAnimated: true,
                                                buttons: {
                                                    Ok: {
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?= base_url()?>index.php/nc_village/NcCommonMyController/viewBhunaksaMap" method="post">
                        <span class="font-weight-bold" style="font-size: 20px;"> DAGS
                            <span id="application_no" class="bg-gradient-danger text-white">
                        ...
                        <?php endif; ?>
                        <span>
                            <input type="hidden" name="location" value="<?= $locations->dist->dist_code.'_'.$locations->subdiv->subdiv_code.'_'.
                            ...
                            <input name="dist_code" value="<?=$locations->village->dist_code?>" type="hidden">
                            <input name="application_no" :value="application_no" type="hidden">
                        ...
                        <span>
                            <button type="button" class="btn btn-info py-2" style="color: white" onclick="viewProposal()">
                    ...
                    <div class="border-top border-dark py-3">
                        <div class="form-group pb-2">
                            ...
                            <?php if($nc_village->jds_revert_note_to_dlr): ?>
                            <label for="" class="form-label mt-1" style="font-weight: bold;">JDS Revert Note </label>
                            <textarea rows="2" class="form-control" readonly><?= $nc_village->jds_revert_note_to_dlr; ?></textarea>
                            <?php endif; ?>
                            ...
                            <div class="form-group pt-2" x-show="nc_village.dlr_verified != 'Y' && nc_village.status =='I'">
                                ...
                                <textarea placeholder="Director of Land Records and Surveys Note" rows="2" x-model="dlr_note" class="form-control" placeholder="Director of Land Records and Surveys Note"></textarea>
                                <div class="pt-2">
                                    ...
                                    <button x-on:click="forwardVillageToJds" class="btn btn-secondary" type="button"><i class="fa fa-forward"></i> Forward to JDS</button>
                            ...
                            <div class="form-group pt-2" x-show="nc_village.status == 'B'">
                                ...
                                <h5 class="text-danger pt-2">This village has been reverted to DC.</h5>
                                <a href="javascript:history.go(-1)"><button class="btn btn-primary" type="button"> <i class="fa fa-arrow-left"></i> GO Back </button></a>
                            </div>
                            <div class="form-group pt-2" x-show="nc_village.dlr_verified == 'Y'">
                                <label for="" class="form-label" style="font-weight: bold;">Director of Land Records and Surveys Note <span style="color:red;">*</span></label>
                                <textarea rows="2" x-text="nc_village.dlr_note" class="form-control" readonly></textarea>
                            ...
                            <div class="form-group pt-2" x-show="nc_village.status == 'P'">
                                <label for="" class="form-label" style="font-weight: bold;">Director of Land Records and Surveys Note <span style="color:red;">*</span></label>
                                <textarea rows="2" x-text="nc_village.dlr_note" class="form-control" readonly></textarea>
                                <h5 class="text-danger pt-2">This village has been forwarded to JDS.<br> DLRS Remark: <span x-text="nc_village.dlr_note"></span></h5>
                                <a href="javascript:history.go(-1)"><button class="btn btn-primary" type="button"> <i class="fa fa-arrow-left"></i> GO Back </button></a>
                            </div>
