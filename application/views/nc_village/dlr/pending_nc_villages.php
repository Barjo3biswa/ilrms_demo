    ...
    function alpineData() {
        return {
            ...
            init() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/getPendingVillages',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
            ...
            getVillages() {
                ...
                $.ajax({
                    url: '<?= base_url(); ?>index.php/nc_village/NcDlrController/getVillagesG',
                    method: "POST",
                    async: true,
                    dataType: 'json',
                    data: {
                    ...
                    <table class="table table-hover table-sm table-bordered">
                        ...
                        <template x-for="(village,index) in villages">
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-sm btn-info text-white" x-bind:href=base_url+"index.php/nc_village/NcDlrController/getPendingVillage?application_no="+village.application_no+"&d="+village.dist_code>Proceed <i class=" fa fa-chevron-right"></i></a>
                                </td>
                            </tr>
                        </template>
