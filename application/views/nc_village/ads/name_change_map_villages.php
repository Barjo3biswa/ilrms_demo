            ...
            forwardToAds(index) {
                ...
                if (village) {
                    ...
                    $.confirm({
                        ...
                        buttons: {
                            Confirm: {
                                text: 'Forward to Additional Director of Survey',
...
<div class="col-lg-12 col-md-12 p-2" x-data="alpineData()">
    <div class="text-center p-2 mb-2" style="font-size:18px; font-weight: bold; background-color: #4298c9; color: white">NC VILLAGE (Forwarded By JDS)</div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        <div>
                            <h5> List of pending Villages forwarded from JDS for Name Change on Map</h5>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <?php foreach ($data as $index => $d) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= base_url() . 'index.php/map/AdsMapController/showVillage?uuid=' . $d->uuid . '&dis=' . $d->dist_code.'&name_change=Y&application_no='.$d->application_no ?>" style="white-space: nowrap;" class="btn btn-info btn-sm">
                                            Upload Map
                                        </a>
                                    </td>
                                </tr>
