...
<div class="row" style='padding: 40px 50px 40px 20px'>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card" style="background-color: #bbe9db;">
            <div class="reza-title">
                <span>PGR/VGR Case</span>
            ...
            <div class="reza-body">
                ...
                <form action="<?php echo base_url(); ?>index.php/Basundhara/getAllVgrCicleDistWise" method="post">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-select districtselect1" aria-label="Default select example" name="selectDistrict" id="" required>
                                    <option disabled selected>Select District (Total PGR/VGR Case)</option>
        ...
        <div class="reza-card">
            ...
            <div class="reza-body" id="showBody">
                ...
                <?php else : ?>
                    ...
                    <!-- DataTable -->
                    <table class='table table-striped table-bordered' id='dataTableVGRCircleLIst' width="100%">
                        <thead>
                            <tr>
                                <th class="center"></th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#select_service').change(function(){
            ...
            $('#dataTableVGRCircleLIst').DataTable().destroy();

            load_data_vgr_circles(select_service);
    
        });

        load_data_vgr_circles();


        //Load Datatable VGR Cases Circles
        function load_data_vgr_circles(select_service) {
            // $('#dataTableVGRCircleLIst thead th:nth-of-type(2)').each(function() {
            //     var title = $(this).text();
            ...
            var table = $('#dataTableVGRCircleLIst').DataTable({
                'pageLength': 10,
                "processing": true,
                "serverSide": true,
                "ordering": false,
                ...
                'ajax': {
                    url: BASE_URL+'index.php/Basundhara/getAllVGRCirclesByDist',
                    type: 'POST',
                    data: {
        ...
        $('#dataTableVGRCircleLIst tbody').on('click', 'input[type="checkbox"]', function(e) {
        ...
        $("#dataTableVGRCircleLIst").on('draw.dt', function() {
