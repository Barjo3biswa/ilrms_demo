    ...
    <div class="col-lg-10">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-3 text-white">
                <li class="breadcrumb-item font-weight-bold"><a href="<?= base_url().'dashboard'?>">Number of Patta</a></li>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-3 text-white">
                <li class="breadcrumb-item font-weight-bold">
                    <a href="<?= base_url().'total-patta-district-wise'?>">
            ...
            <table class="table table-hover text-center tab1">
                ...
                <tbody>
                    <?php
                        ...
                        $cirwise = $circlePattaCount->result();
