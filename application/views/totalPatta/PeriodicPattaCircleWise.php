	...
	<div class="col-lg-10">
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb p-3 text-white">
				<li class="breadcrumb-item font-weight-bold"><a href="<?= base_url().'periodic-patta-district-wise'?>">Number of Periodic Patta</a></li>
		...
		<nav aria-label="breadcrumb">
			<ol class="breadcrumb p-3 text-white">
				<li class="breadcrumb-item font-weight-bold">
					<a href="<?= base_url().'periodic-patta-district-wise'?>">
	...
	<div class="tab-content">
		<div class="card-body">
			<table class="table table-hover text-center tab1">
				...
				<?php
				$i =1;
				foreach($circlePeriodicPattaCount as $key=>$row) :
					?>
					<tr>
						<td><?= $i++ ?></td>
