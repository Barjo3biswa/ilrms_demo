        ...
        <div class="row">
            ...
            <div class="col-lg-12 " align="right">
                <div class="table-responsive">
                    ...
                    <table class="datatable table table-stripped" id='datatableJuridicalCaseListForVerification'>
                        <thead >
                            <tr>
...
<script>
    ...
    {
        $('#datatableJuridicalCaseListForVerification thead th:nth-of-type(2)').each(function () {
            var title = 'Case';
            $(this).html('<input type="text" class="input_search form-control form-control-sm" placeholder="Search ' + title + '" data-column-index="0" />');
        });

      var table = $('#datatableJuridicalCaseListForVerification').DataTable({
        'pageLength': 10,
        "processing": true,
        "serverSide": true,
        "ordering"  : false,
        ...
        'ajax':{
        url: baseurl + "DeptJuridical/getPendingJuridicalCaseListUnderAssistant",
          type:'POST',
          data: {
     ...
     $('.search_button').on('click', function() {
            ...
            $('#datatableJuridicalCaseListForVerification').DataTable().destroy();
            load_juridical_datatable();
        });


        var selectedCheckBoxArray = [];
        $('#datatableJuridicalCaseListForVerification tbody').on('click', 'input[type="checkbox"]', function(e) {
        ...
        $("#datatableJuridicalCaseListForVerification").on('draw.dt', function() {
