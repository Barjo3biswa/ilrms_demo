...
<div class="col-lg-10 offset-1 mb-5">
                    ...
                    ?>
                        ...
                        <?php if($lmnote->already_alloted == 'Y'){ ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control"  name="actual_purpose_use" value="<?=$lmnote->actual_purpose_use=='Y' ? "YES" : "NO"?>" readonly>
    ...
    <script>
        ...
        function SelfAndDocument(dist_code) {
    ...
    <div class="vertical-view-section" role="tabpanel" id="history">
        <div class="reza-card ">
            <div class="reza-body">
                <h5 class="reza-title"  style="margin-top: 15px">
                    <i class="fa fa-history" aria-hidden="true"></i> Primary Information Entered by CO (চক্ৰ বিষয়া.-ৰ দ্বাৰা প্ৰবিষ্ট কৰা প্ৰাথমিক তথ্য)
                </h5>
                <div class="tableCard">
...
<script>
    ...
    function forward_to_js_from_aso()
    {
        ...
        //alert(case_no);
            $.ajax({
            url: baseurl + "DeptJuridical/sentJuridicalCasesFromAsoToJs",
            type: "POST",
            dataType: "json",
