    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="reza-card">
            <div class="reza-title">
                <span>Digitalized Settlement of land to non-individual juridical entities</span>
                ...
                success: function(data) {
                    if (data.responseType == 1) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                // location.reload(true);
                                $('#datatableJuridicalCaseList').DataTable().ajax.reload(null, false);
                                $('#markVerificationModal').modal('hide');
...
$(document).on('click', '#confirmSentForVerificationASO', function() {
    ...
    {
        alert("Remarks field is mandatory !!!");
        return;
    }
    ...
    if (selectedList.length > 0) {
        ...
        $.ajax({
            url: baseurl + "DeptJuridical/sentJuridicalCasesForVerification",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
