...
<div class="p-2 bg-primary text-center text-white h5 shadow-sm border border-white rounded"><b>Village Land Bank Info District Wise</b>
</div>
	...
	<div class="tab-content">
		<div class="card-body">
			<table class="table table-hover text-center tab1" id="tab">
				...
				<?php
				$i=1;
				foreach($distrcit_vlb_count as $key=>$row) :
					?>
					<tr>
						<td><?= $i++;?></td>
						...
						<td><?= $row->chitha_govt_dags ?></td>
						<td><?= $row->pending_vlb_dags ?></td>
						<td align="center">
							<a href="<?= base_url().'village-land-bank-circle-wise/'.$row->district_code?>">
