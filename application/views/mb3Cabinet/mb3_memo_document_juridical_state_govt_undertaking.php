                ...
                <div class="row mt-3 text-center" style="text-align: center;">
                    ...
                    <div class="reza-title" style="text-align: center;">
                        ...
                        <div class="row">
                            <div class="col-12" style="text-align:justify;font-size:12px">
                                ...
                                <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                    Allotment of land to be followed by settlement in favour of Projects/Infrastructure of State Government Undertakings such as Boards, Corporations etc. under Mission Basundhara 3.0
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    2. INTRODUCTION :
                                </div>
                                <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                                    This is regarding allotment of government land to be followed by settlement in favour of <b style="color:red"><?= $total_prop; ?></b> Projects/Infrastructure of State Government Undertakings such as Boards, Corporations etc in various Districts across the State of Assam. A list of such Projects / Infrastructure department wise along with the details of land, location, dag, area, purpose etc.  has been prepared as per proposals received from the District Commissioners concerned and placed at Annexure-I
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    3. BACKGROUND:
                                </div>
                                <div class="col-12 mrigankaText">
                                    Proposals for allotment of government land to be followed by settlement in favour of varied <b style="color:red"><?= $total_prop; ?></b> Projects/Infrastructure of  State Government Undertakings such as Boards, Corporations etc have  been  received  from  different Districts under Mission Basundhara 3.0 after recommendation of the concerned SDLAC.
                                </div>
                                <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                                    4. PROPOSAL:
                                </div>
                                <div class="col-12" style="text-align:justify;font-size:12px">
                                    <ol type="i">
                                        ...
                                        <li>
                                            ii. The applicant entity/institution (relevant State Government Undertaking such as Board, Corporationetc) have accordingly submitted the applications in Mission Basundhara Portal along with project details,self-declaration,land & area details, etc.
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            iv. Proposals for allotment of land to be followed by settlement in favour of these <b style="color:red"><?= $total_prop; ?></b> Projects / Infrastructure of State Government Undertakings such as Boards, Corporations etc have been recommended by SDLAC and approved by concerned Gurdian Minister.
                                        </li>
                            ...
                            <div class="col-12" style="text-align:justify;font-size:12px">
                                <ol type="i">
                                    <li>
                                        I. As per Govt letter dated RSS.288/81/4 dated 2/4/1982 the District Commissioners to send proposals for settlement in favour of State Government undertakings such as Boards, Corporations etc. indicating the present market value of lands supported by Sale statement period on the basis of last three years regd.sale deeds of lands of the same class and utility of the locality. Copy at Annexure II.
                                    </li>
                                    <li>
                                        II. As per Office Memorandum ECF No.106184/2019/11 dated 2/6/2022 Government land in rural areas required by the State Govt undertakings/statutory bodies/parastatals etc. like State Warehousing Corporation (SWHC) etc. responsible for construction of warehouse/godown under paddy Procurement Scheme shall be allotted without referring to the Govt for prior approval, subject to the recommendation of the Land Advisory Committee. Copy at Annexure III.                                
                                    </li>
                                    <li>
                                        III. As per Govt. notification eCF No.565802/I/776018/2024 Dated 19-10-2024, the District Commissioners are delegated the power for allotment of Government land to State Government Undertaking / Statutory Bodies / Parastatals etc. like State Warehousing Corporation (SWHC) which are responsible for construction of warehouse/godown under Paddy Procurement Scheme, subject to recommendation of the Land Advisory Committee in rural areas.All other proposals of allotment of Govt. land to be followed by settlement to the State Government undertakings such as Boards, Corporations etc. in rural areas and all allotment to be followed by settlement proposals of Government land to the State Government Departments/Undertakings in urban area should be  forwarded to the Government for approval, after recommendation of Land Advisory Committee. Copy at Annexure IV.                                
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12" style="text-align:justify;font-size:12px">
                            <ol type="i">
                                <li>
                                    i. These proposals have been processed together under Mission Basundhara 3.0 keeping in mind the greater benefitof the State & welfare of the citizens, as allotment of government land to be followed by settlement for such projects can promote social welfare ,community development, improve access to quality healthcare and education, industrial development, create employment opportunities etc in various sectors.                                    
                                </li>
                                <li>
                                    ii. Allotment of land to be followed by settlement to the State Government Undertakings such as boards, corporations etc can support the development of public utilities, such as roads, educational institutions, and other social infrastructure.                                    
                                </li>
                                <li>
                                    iii. These proposals also entail strategic allocation of Government land which can attract public/private investments, stimulating economic growth and development.
                                </li>
                                <li>
                                    iv. Allotment of land to be followed by settlement for such infrastructure projects, can improve the quality of life for citizens and enhance the State's competitiveness bringing governance and development closer to citizens across the State.
                                </li>
                                <li>
                                    v. Further on later settlement of the such allotted lands to the State Government Undertaking such as Board, Corporation etc. will also entail associated accrued revenue collection for the State Exchequer.
                                </li>
                                <li>
                                    vi. The SDLACS concerned have already recommended these proposals and submitted through the Deputy Commissioners for Government consideration.
                                </li>
                            </ol>
                        </div> 
                        <div class="reza-title" style="margin-bottom: 10px; margin-top: 15px">
                        ...
                        <div class="col-12 mrigankaText" style="text-align:justify;font-size:12px">
                           Approval of the Cabinet is required for allowing allotment of Government land to be followed by settlement in favour of <b style="color:red"><?= $total_prop; ?></b> Projects/Infrastructure of State Government Undertakings such as board, corporations etc. in various Districts across the State of Assam as placed at Annexure-I                                                           
                        </div>
