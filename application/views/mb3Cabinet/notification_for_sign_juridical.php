                ...
                <div class="container bg-white divCard pb3"  id="html5">
                    <div class="row mt-4" style=" margin-right: 50px; margin-left: 50px;font-size:14px">
                        <div class="col-lg-12" style="text-align:justify;font-size:14px">
                            Sub : <span style="margin-left: 40px;"><?=$ins_cat_name?> of <b><?=$dist_name ?></b> District under Mission Basundhara 3.0.</span>
                        </div>
                    </div>
                </div>
                <div class="container bg-white divCard pb3"  id="html6">
                    <div class="row mt-4" style=" margin-right: 50px; margin-left: 50px;font-size:14px">
                        <div class="col-lg-12" style="text-align:justify;font-size:14px">
                                ...
                                In inviting a reference to the subject cited above, I am directed to convey that the Governor of Assam is pleased to accord approval for <b><?= $total_prop ?></b> No.s of proposals submitted by the District Commissioner, <b><?=$dist_name ?></b> respectively in favour of non juridical entities under Mission Basundhara 3.0.
                            </span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mt-4" style=" margin-right: 50px; margin-left: 50px;font-size:14px">
                        <div class="col-lg-12" style="text-align:justify;font-size:14px">
                            <span style="margin-left: 80px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                "basundhara.assam.gov.in" of Mission Basundhara 3.0 for further necessary action at your
                                end.
                            </span>
                        </div>
                    </div>
...
<script type="text/javascript">
  ...
  // final submit & generate PDF
    $(document).on("click",'#generatePDFnotificationSign',function(){
            ...
            $.ajax({
                url: BASE_URL + "DeptMb3Cabinet/SavePDFNotificationCopySign",
                type: "post",
                dataType: "json",
                data: {
			...
			// $.unblockUI();
	            $('#generatePDFnotificationSign').hide();
                    $('#closeNotificationModal').hide();
    ...
    $(document)
        .ready(function(){
            ...
            function saveFinalDataPDF(signedPdfData)
            {
                ...
                $.ajax({
                    url : BASE_URL+ "DeptMb3Cabinet/signedAndFinalApproveByDept",
                    type : "post",
                    dataType : "json",
                    contentType : 'application/json',
                    data : JSON.stringify(requestData),
