                ...
                <div class="container bg-white divCard pb3"  id="html5">
                    <div class="row mt-4" style=" margin-right: 50px; margin-left: 50px;font-size:14px">
                        <div class="col-lg-12" style="text-align:justify;font-size:14px">
                            Sub : <span style="margin-left: 40px;">End to end digitalisation of Annual Patta to Periodic Patta with rationalised premium rates in urban area and peripheral
                            area  <b><?=$dist_name ?></b> District under Mission Basundhara 3.0.</span>
                        </div>
                    </div>
                </div>
