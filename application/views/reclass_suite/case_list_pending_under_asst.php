        ...
        <div class="row">
            ...
            <div class="col-lg-12 " align="right">
                <div class="table-responsive">
                    ...
                    <table class="datatable table table-stripped" id='datatableReclassSuiteCaseListForVerification'>
                        <thead >
                            <tr>
...
<script>
    ...
    {
        $('#datatableReclassSuiteCaseListForVerification thead th:nth-of-type(2)').each(function () {
            var title = 'Case';
            $(this).html('<input type="text" class="input_search form-control form-control-sm" placeholder="Search ' + title + '" data-column-index="0" />');
        });

      var table = $('#datatableReclassSuiteCaseListForVerification').DataTable({
        'pageLength': 10,
        "processing": true,
        "serverSide": true,
        "ordering"  : false,
        ...
        'ajax':{
        url: baseurl + "DeptReclassSuite/getPendingReclassSuiteCaseListUnderAssistant",
          type:'POST',
          data: {
        ...
        columnDefs: [{
                ...
                'render': function(data, type, row) {
                    ...
                    var arr = myArray[3];
                    return '<input type="checkbox" class="checkBoxD selectMark" value=' + row[0] + ' id=' + arr + ' name="selectMark[]" hidden>';
                }
            }],
      });
     ...
     $('.search_button').on('click', function() {
            ...
            $('#datatableReclassSuiteCaseListForVerification').DataTable().destroy();
            load_reclass_suite_datatable();
        });


        var selectedCheckBoxArray = [];
        $('#datatableReclassSuiteCaseListForVerification tbody').on('click', 'input[type="checkbox"]', function(e) {
        ...
        $("#datatableReclassSuiteCaseListForVerification").on('draw.dt', function() {
