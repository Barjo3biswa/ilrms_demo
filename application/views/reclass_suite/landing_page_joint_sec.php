            ...
            <div class="modal-content">
                <div class="modal-header bg-danger">
                        <h5 class="modal-title w-100">
                            ...
                            <input type="hidden" value="40" id="service_code" name="service_code">
                ...
                <div class="modal-body " style="font-size:15px">
                    <div class="form-group">
                        <label for="">Select Cabinet Memoo</label>
...
<script>
    ...
    $('#dist_select_btn_submit').on('click', () => {
            ...
            $.ajax({
                url: baseurl + "DeptReclassSuite/viewPendingReclassSuiteCases" ,
                type: "POST",
                ...
                success: function(data) {
                    if (data.responseType == 1) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                // location.reload(true);
                                $('#datatableReclassSuiteCaseList').DataTable().ajax.reload(null, false);
                                $('#markVerificationModal').modal('hide');
...
$(document).on('click', '#confirmSentForVerificationASO', function() {
    ...
    if (selectedList.length > 0) {
        ...
        $.ajax({
            url: baseurl + "DeptReclassSuite/sentReclassSuiteCasesForVerification",
            type: "POST",
            dataType: "json",
            contentType: "application/json",
            success: function(data) {
