                        ...
                        <thead>
                            <tr>
                                ...
                                <label class="control-label">Meeting</label>
                                    <select class="form-select input_search" aria-label="Default select example" name="select_meeting" id="select_meeting">
                                        <option value="">--Select Meeting--</option>
                                            <?php foreach ($meetingList as $meeting) :  ?>
                                                <option value="<?= $meeting->meeting_id; ?>"><?=$this->utilclass->getMeetingNameByMeetingId($meeting->dist_code,$meeting->meeting_id); ?>
                                        </option>
                                            <?php endforeach; ?>
                                    </select>
                                </th>
...
<script>
    ...
    $(document).ready(function() {
        $('#select_service,#select_meeting,#select_district').change(function(){
            ...
            load_data_cab_case_list(select_service,select_meeting,select_district);
        ...
        function load_data_cab_case_list(select_service,select_meeting,select_district) {
            ...
            // $('#dataTableDeptByCabId thead th:nth-of-type(4)').each(function() {
            //     var title = $(this).text();
            //     $(this).html(title + ' <input type="text" class="form-control input_search form-control-sm" placeholder="----------  search ' + title + '------------" />');
            // });
            ...
            var table = $('#dataTableDeptByCabId').DataTable({
                ...
                'ajax': {
                    url: BASE_URL+'index.php/CabController/getAllCasesUnderCabId',
                    type: 'POST',
                    data: {
                        CabId: cab_id,
        ...
        $('.selectMark:checked').each(function(i) {
            ...
            // return;
            $.ajax({
                url: BASE_URL + "/CabControllerReviewPerpetual/removeCasesFromCabMemo",
                type: "POST",
                dataType: "json",
