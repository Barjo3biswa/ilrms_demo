  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="reza-card" style="background-color: #bbe9db;">
      <div class="reza-title">
        <span>Create PGR/VGR CAB ID</span>
      ...
      <div class="reza-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="form-group">
              <label style="color: #666">Select District(s) to create PGR/VGR CAB ID</label>
        ...
        <div class="row" style="margin-top: 15px" align="right">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <button type="button" id="createCabId" class="rezaButt buttInfo" id="" style="width: 220px">
                    <i class="fa fa-plus" aria-hidden="true"></i> Create VGR CAB ID
                </button>
            </div>
        </div>
      </div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table_div_responsive">
    <div class="reza-card">
      <div class="reza-title">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <span class="text-danger">List of Generated Cab ID For PGR/VGR</span>
          </div>
        </div>
        <hr style="margin-bottom: -5px">
      </div>
      ...
      <div class="reza-body" id="showBody">
        <table class='table table-striped table-bordered table-responsive' id='dataTableCabVGR' width="100%" >
          <thead>
            <tr>
...
<script>
  ...
  $(document).on('click', '#createCabId', function(){
    ...
    if (selectedDistricts.length > 0)
    {
      ...
      $.ajax({
        url: BASE_URL + "CabController/generateVGRCabId",
        type: "post",
        dataType: "json",
  ...
  $(document).ready( function () {
    ...
    {
      var table = $('#dataTableCabVGR').DataTable({
        'pageLength': 10,
        "processing": true,
        "serverSide": true,
        "ordering"  : false,
        ...
        'ajax':{
          url: BASE_URL+'index.php/CabController/getGeneratedCabListVGR',
          type:'POST',
          data: {status: 0},
          deferLoading: 57,
        },
  ...
  //Delete VGR Cab 
  function deleteCabMemoVGR(cab_id_delete)
  {
    const cablist = {
    ...
    Swal.fire({
        ...
        if (result.value) {
            $.ajax({
            url: BASE_URL + "CabController/deleteCabIdVGR",
            type: "post",
            dataType: "json",
            contentType: "application/json",
            success: function (data) {
