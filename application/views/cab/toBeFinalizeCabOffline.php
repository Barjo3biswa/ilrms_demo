  ...
  $(document).ready( function () {
    ...
    function load_data(selectDistrict)
    {
      var table = $('#dataTableCab').DataTable({
        ...
        'ajax':{
          url: base_url+'index.php/CabController/getCabIdByUserDistrictOffline',
          type:'POST',
...
$(document).ready(function(){
  $('#generateMemoPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        $.ajax({
            type        : 'POST', 
            url         : base_url +'CabController/GenerateCabMemoOffline', 
            data        : formData, 
            // dataType    : 'json', 
            encode      : true,
            success: function(data){
  ...
  // final submit & generate PDF
    $(document).on("click",'#generatePDFMemo',function(){
        ...
        else
        {
            ...
            $.ajax({
                url: base_url + "CabController/SavePDFMemoOffline",
                type: "post",
                dataType: "json",
                data: {
