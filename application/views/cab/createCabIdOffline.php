  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="reza-card">
      <div class="reza-title">
        <span class="text-danger">Create CAB ID for Offline Settlement Khas Land</span>
      ...
      <div class="reza-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:14px;">
            <div class="form-group">
...
<script>
  ...
  $(document).on('click', '#createCabId', function(){
    ...
    if (selectedDistricts.length > 0)
    {
      ...
      $.ajax({
        url: BASE_URL + "CabController/generateCabIdOffline",
        type: "post",
        dataType: "json",
  ...
  $(document).ready( function () {
    ...
    function load_generated_cab_list()
    {
      var table = $('#dataTableCab').DataTable({
        ...
        'ajax':{
          url: BASE_URL+'index.php/CabController/getNewlyGeneratedCabListOffline',
          type:'POST',
          data: {status: 0},
          deferLoading: 57,
        },
  ...
  function viewCaseDetail(cab_id)
  {
    ...
    $.ajax({
      url: BASE_URL + "CabController/createCabIdOffline",
      type: "post",
      dataType: "json",
      contentType: "application/json",
      success: function (data) {
