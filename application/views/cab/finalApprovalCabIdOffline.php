    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <div class="reza-card">
        <div class="reza-title">
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              <span class="text-danger">Final Approval:   <mark>Do not click final button without Approval from Cabinet</mark></span>
            </div>
...
<script type="text/javascript">
  ...
  $(document).ready( function () {
    ...
    function load_data(selectDistrict)
    {
      var table = $('#dataTableCab').DataTable({
        ...
        'ajax':{
          url: base_url+'index.php/CabController/getCabIdByUserDistrictFinalApprovalOffline',
          type:'POST',
  ...
  $('#generateNotificationPost').on('submit', function(event){
    ...
    var formData = $(this).serialize();
        ...
        $.ajax({
            type        : 'POST', 
            url         : base_url +'CabController/GenerateNotificationOffline', 
            data        : formData, 
            // dataType    : 'json', 
            encode      : true,
            success: function(data){
