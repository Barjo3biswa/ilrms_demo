...
<?php $services = json_decode(DEPT_MB2_SERVICES_TYPES)?>
<div class="row" style='padding: 40px 50px 40px 20px'>
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">

    <div class="reza-card">
      <div class="reza-title">
        <span>Create CAB ID</span>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            <div class="form-group">
              <label style="color: #666">Select Service Type</label>
                <select class="form-select" aria-label="Default select example" id="service_type" name="service_type">
                    <option value="00" selected>SELECT TYPE</option>
                    <?php foreach ($services as $key => $ser) { ?>
                        <option value="<?php echo $ser->value; ?>"><?php echo $ser->name; ?></option>
                    <?php  } ?>
                </select>
            </div>
          </div>
          ...
          <!-- <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="form-group">
              <label style="color: #666">Reference Number</label>
              <input type="text" class="form-control" id="cab_ref_no" value="" placeholder="Enter Reference No">
            </div>
          </div> -->
            ...
            <div class="form-group">
              ...
              <?php foreach($user_assigned_dist as $row) { ?>
                ...
                <div class="row">
                  ...
                  <!-- <div class="col-lg-4">
                    <div class="form-check">
                      <input class="form-check-input selectDistricts" type="checkbox" value="02" id="02">
                      <label class="form-check-label" for="flexCheckDefault">
                        Dhubri
                      </label>
                    </div>
                  ...
                  <div class="col-lg-4">
                    <div class="form-check">
                      <input class="form-check-input selectDistricts" type="checkbox" value="03" id="03">
                      <label class="form-check-label" for="flexCheckDefault">
                        Goalpara
                      </label>
                    </div>
        ...
        <div class="row" style="margin-top: 15px" align="right">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <button type="button" id="createCabId" class="rezaButt buttInfo" id="" style="width: 200px">
                    <i class="fa fa-search" aria-hidden="true"></i> Create CAB ID
                </button>
            </div>
        </div>
      </div>
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table_div_responsive">
    <div class="reza-card">
      <div class="reza-title">
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <span class="text-danger">List of Generated Cab ID</span>
          </div>
        </div>
        <hr style="margin-bottom: -5px">
      </div>
        ...
        <table class='table table-striped table-bordered table-responsive' id='dataTableCab' width="100%" >
          <thead>
            <tr>
              ...
              <th class="center"><label class="control-label">CAB Type</th>
...
<script>
  ...
  $(document).on('click', '#createCabId', function(){
    ...
    if (selectedDistricts.length > 0)
    {
      const list = {
        ...
        cab_type         : $('#service_type').val(),
      };
      $.ajax({
        url: BASE_URL + "CabControllerReviewPerpetual/generateCabId",
        type: "post",
        dataType: "json",
  ...
  $(document).ready( function () {
    ...
    function load_generated_cab_list()
    {
      var table = $('#dataTableCab').DataTable({
        ...
        'ajax':{
          url: BASE_URL+'index.php/CabControllerReviewPerpetual/getNewlyGeneratedCabList',
          type:'POST',
          data: {status: 0},
          deferLoading: 57,
        },
  ...
  function viewCaseDetail(cab_id)
  {
    ...
    $.ajax({
      url: BASE_URL + "CabControllerReviewPerpetual/createCabId",
      type: "post",
      dataType: "json",
      contentType: "application/json",
      success: function (data) {
