            ...
            <tr>
                ...
                <td>
					<?php if ($pen['service_code'] == SETTLEMENT_TENANT_ID) { ?>
						<a href='<?php echo base_url() ?>index.php/Basundhara/settlementBasu?app=<?= $pen['case_no'] ?>' class="btn btn-sm  btn-primary"><i class='fa fa-eye'></i> View Details</a>
				</td>
			<?php } else if ($pen['service_code'] == SETTLEMENT_AP_TRANSFER_ID) { ?>
				<a href='<?php echo base_url() ?>index.php/Basundhara/settlementBasu?app=<?= $pen['case_no'] ?>' class="btn btn-sm  btn-primary"><i class='fa fa-eye'> View Details</a></td>
