<?php
class DeptConversionNew extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('conversion/DeptConversionNewModel');
        $this->db2 = NULL;
    }
    ...
    public function conversionCaseDetails()
    {
        ...
        $petition_basic = $this->DeptConversionNewModel->getPetitionBasicDetails($this->db2,$case_no)->row();
        

        $landdetails = $this->DeptConversionNewModel->getLandDetails($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code, $petition_basic->mouza_pargona_code, $petition_basic->lot_no, $petition_basic->vill_townprt_code, $petition_basic->petition_no)->row_array();
        
        $pattadardetails = $this->DeptConversionNewModel->getPattadardetails($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code, $petition_basic->mouza_pargona_code, $petition_basic->lot_no, $petition_basic->vill_townprt_code, $petition_basic->petition_no, $landdetails['dag_no'], $landdetails['patta_no'], $landdetails['patta_type_code']);
        
        $data['conv_type'] = $conversionType = $this->DeptConversionNewModel->getConversionType($this->db2);
        ...
        $data['lm_details_final'] = $petitionLMNote = $this->DeptConversionNewModel->getPetitionLMNote($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code, $petition_basic->mouza_pargona_code, $petition_basic->lot_no, $petition_basic->vill_townprt_code, $petition_basic->petition_no)->result();
        
        $data['lm_details'] = $lm_details = $this->DeptConversionNewModel->getPetitionLMNote($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code, $petition_basic->mouza_pargona_code, $petition_basic->lot_no, $petition_basic->vill_townprt_code, $petition_basic->petition_no)->row_array();
        ...
        $namelm = $this->DeptConversionNewModel->getLmDetails($this->db2,$lm_details['lm_code'], $petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code, $petition_basic->mouza_pargona_code, $petition_basic->lot_no)->row();
        $data['lm_name'] = $namelm->lm_name;
       
        $skname = $this->DeptConversionNewModel->getSkUserDetails($this->db2,$lm_details['user_code'], $petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code)->row();
        // echo "<pre>";
        // var_dump($this->db2->last_query());die;
        $data['sk_skname'] = $skname->username;

        $bo_details = $this->DeptConversionNewModel->getBoDetails($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code,$petition_basic->mouza_pargona_code, $petition_basic->lot_no,$petition_basic->vill_townprt_code,$petition_basic->petition_no)->row_array();
        ...
        if ($bo_details != NULL) {
                   $data['bo_details'] = array(
                    ...
                    $boname = $this->DeptConversionNewModel->getUserDetails($this->db2,$bo_details['bo_code'],$bo_details['dist_code'])->row();

                   $data['bo_boname'] = $boname->username;

               }
                    $data['cases'] = $this->DeptConversionNewModel->getPetitionProceeding($this->db2,$case_no)->result();

                    $data['dc_adc_order'] = $this->DeptConversionNewModel->getPetitionProceedingDcAdc($this->db2,$case_no)->result();

                    $data['dept_order'] = $this->DeptConversionNewModel->getPetitionProceedingDeptJs($this->db2,$case_no)->result();


                    $data['bo_details_final'] = $this->DeptConversionNewModel->getPetitionBoNote($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code,$petition_basic->mouza_pargona_code, $petition_basic->lot_no,$petition_basic->vill_townprt_code,$petition_basic->petition_no)->result();
               ...
               $data['basundharaAttachment']=$this->DeptConversionNewModel->searchBasundharaLink($this->db2,$case_no);


                        $this->db = $this->load->database('db2', TRUE);
                        $assistantVerification=$this->DeptConversionNewModel->getAssistantVerificationDetails($this->db,$case_no)->result();
        ...
        $data['_view'] = 'conversion/conversionLandingNew';
                ...
                if ($case_no != null || $case_no!= "") 
                    {
                        ...
                        $updatePettBasicStatus = $this->DeptConversionNewModel->updatePetitionBasicForCab($this->db2,$case_no, $dist_code, $updateData,$insSetProceed);
    ...
    public function approveConversionByJs()
    {
        ...
        $updateDharitree=$this->DeptConversionNewModel->updatePetitionBasicForConversion($this->db2, $updateArrDhar, $whereArr);
    ...
    public function finalOrderByPs()
    {
        ...
        $updateDharitree=$this->DeptConversionNewModel->updatePetitionBasicForConversion($this->db2, $updateArrDhar, $whereArr);
            ...
            }else
            {
                ...
                {
                    $updateIlrms=$this->DeptConversionNewModel->updateConversionIlrmsByDpt($this->db, $updateArrIlrms, $whereArr);
    ...
    public function conversionLanding()
    {
        ...
        $data['_view'] = 'conversion/conversion_landing_asst_new';
        }
        else
        {
        ...
        $data['_view'] = 'conversion/conversion_landing_js_new';
        }
        $this->load->view('layouts/main', $data);
    }
    ...
    public function viewConversionCases()
    {
        ...
        $this->db2 =  $this->dbswitch2($dist_code);
        $ast = ASSISTANT_USERCODE;
        // $data['ast_list'] = $this->db->query("SELECT name,user_code,email,designation FROM depart_users WHERE designation in ('$ast')",array())->result();
        $data['assistant_list'] = $this->db->query("SELECT * FROM depart_users WHERE designation=? 
                                    AND active_deactive=?", array('ASSISTANT', 'E'))->result();
        $data['status'] = true;
        $this->load->view('conversion/conversion_case_list_new',$data);
	}
    ...
    public function getPendingConversionCaseList() 
    {
        ...
        $case_list = $this->DeptConversionNewModel->getPendingCaseListDetails($this->db2,$start, $length, $order,$dist_code,$searchByCol_0);
       // var_dump($case_list);exit;
        ...
        if($case_list['total_records'] >  0){
            ...
            foreach($data_rows as $row) {
                ...
                $url = base_url('DeptConversionNew/conversionCaseDetails');
                ...
                if($ast_verification == 'A'){
                    ...
                    $url = base_url('DeptConversionNew/viewAssistantVerificationDetails');
                    $url .= '?dist_code=' . urlencode($row->dist_code);
                    $url .= '&case_no=' . urlencode($row->case_no);
    ...
    public function getAllConversionCasePs() 
    {
        ...
        $case_list = $this->DeptConversionNewModel->getPendingCaseListPs($this->db,$start, $length, $order,$searchByCol_0);
    ...
    public function clearConversionCaseData()
    {
        ...
        foreach($casesList as $cases)
        {
            ...
            if($updateDharitree > 0){
                    ...
                    // $deleteIlrms=$this->DeptConversionNewModel->deleteConversionCases($this->db);
    ...
    {    
        ...
        $conversionCabinetDetails = $this->DeptConversionNewModel->getConversionCabinetList($start, $length, $order,$status,$user_code);
    ...
    public function getCabMemos() {
        ...
        $cabIdListConversion = $this->DeptConversionNewModel->getAllConversionCabList($dist_code,$user_code);
                ...
                if (!empty($allSelectedList)) 
                    {
                        foreach ($allSelectedList as $caseN) 
                        {
                            ...
                            $memo_name = $this->DeptConversionNewModel->getMemoNameByCabId($this->db,$cabmemo_id);
                            ...
                            if ($insertCabList != TRUE) {
                                ...
                                $updateCabIdList = $this->DeptConversionNewModel->updateConversionCabStatus($this->db,$where, $updateData);
                                if ($updateCabIdList <= 0) {
                                    ...
                                    $updatePetBasicStatus = $this->DeptConversionNewModel->updatePetitionBasicForCab($this->db2,$case_no, $dist_code, $updateData);
    ...
    public function getTobeFinalizeConversionCabinet() 
    {
        ...
        $memo_list = $this->DeptConversionNewModel->getConversionCabinetList($start, $length, $order,$status,$user_code);
        ...
        if($memo_list['total_records'] > 0){
            ...
            $link = base_url() . "index.php/DeptConversionNew/getListOfConversionCasesByCabId?cab_id=".$row->cab_id;
            ...
            $link2 = base_url() . "index.php/DeptConversionNew/downloadConversionCaseReport?cab_id=".$row->cab_id;
    ...
    public function getFinalizedConversionCabinet() 
    {
        ...
        $memo_list = $this->DeptConversionNewModel->getPendingConversionCabinetList($start, $length, $order,$user_code);
        ...
        if($memo_list['total_records'] > 0){
            ...
            $link2 = base_url() . "index.php/DeptConversionNew/viewConversionMemo?cab_id=".$row->cab_id;
    ...
    public function approveConversionCabinetByPS() {
        ...
        $updateCabinetStatus = $this->DeptConversionNewModel->updateConversionCabStatus($this->db,$where, $updateData);
    ...
    public function finalApproveConversionByJS_olddddddddddd()
    {
        ...
        $checkMemoStatus = $this->DeptConversionNewModel->checkCabMemoStatus($this->db,$cabinet_id);
        ...
        $case_district = $this->DeptConversionNewModel->getDistrictUnderCabMemo($this->db,$cabinet_id)->result();

        foreach ($case_district as $dist) {
            $district = $dist->dist_code;
            $conversionCasesForFinalSubmitByDist = $this->DeptConversionNewModel->getConversionCasesForFinalSubmit($this->db, $cabinet_id, $user_code, $district)->result();
            ...
            foreach ($conversionCasesForFinalSubmitByDist as $row) {
                ...
                if ($insertProceeding != 1) {
                    ...
                    $updateCabCasesIlrms = $this->DeptConversionNewModel->updateConversionIlrmsByDpt($this->db, $updateArrCabCasesIlrms, $whereArr);
                    ...
                    if ($updateCabCasesIlrms <= 0) {
                        ...
                        $updateCabMemoIlrms = $this->DeptConversionNewModel->updateConversionCabStatus($this->db,$whereCabMemo, $updateArrCabMemoIlrms);
    ...
    public function getApprovedConversionCabinet() 
    {
        ...
        $memo_list = $this->DeptConversionNewModel->getApprovedConversionCabinetList($start, $length, $order,$user_code);
    ...
    public function getListOfConversionCasesByCabId()
    {
        ...
        $memo_name = $this->DeptConversionNewModel->getMemoNameByCabId($this->db,$cab_id);
    ...
    public function getAllCasesUnderCabId() 
    {
        ...
        $cases_list = $this->DeptConversionNewModel->getAllCasesbyCabId($this->db,$start, $length, $order,$cab_id,$dist_code);
    ...
    public function sentConversionCasesForVerification()
    {
        ...
        $this->form_validation->set_rules('selectAssistant', 'Assistant', 'trim|required');
                        ...
                        foreach ($allSelectedList as $caseN) 
                        {
                            $case_no =$caseN;
                                    ...
                                    if($verificationType == JS_VERIFICATION)
                                    {
                                        ...
                                        $checkAstAsgn = $this->db2->query("SELECT * FROM petition_basic WHERE case_no=? AND 
                                    ...
                                    $updatePetBasicStatus = $this->DeptConversionNewModel->updatePetitionBasicForCab($this->db2,$case_no, $dist_code, $updateData,$insSetProceed);
    ...
    public function getPendingConversionCaseListForVerification() 
    {
        ...
        $case_list = $this->DeptConversionNewModel->getPendingCaseListDetailsForVerificationSO($this->db2,$start, $length, $order,$dist_code,$searchByCol_0);
    ...
    public function viewConversionCasesDptAsst()
    {
        ...
        $data['status'] = true;
        $this->load->view('conversion/case_list_pending_under_asst_new',$data);
	}
    ...
    public function getPendingConversionCaseListUnderAssistant() 
    {
        ...
        $case_list = $this->DeptConversionNewModel->getPendingCaseListDetailsForVerificationAsst($this->db2,$start, $length, $order,$dist_code,$searchByCol_0);
    ...
    public function addConversionCasesToProposal()
    {
        ...
        } else 
        {
            ...
            if (empty($allSelectedList)) 
            {
                ...
                $checkUnverifiedCases = $this->DeptConversionNewModel->getAllUnverifiedPendingCases($this->db2,$casesList);
                ...
                $checkExistingCases = $this->DeptConversionNewModel->getExistingCasesUnderProposal($this->db,$casesList);
    ...
    public function getPendingConversionProposalCaseList() 
    {
        ...
        $case_list = $this->DeptConversionNewModel->getPendingProposalCaseListDetails($this->db,$start, $length, $order,$searchByCol_0);
    ...
    public function generateProposalListFromCases()
    {
        ...
        foreach ($allSelectedList as $caseN) 
        {
            ...
            $updateProposalList = $this->DeptConversionNewModel->updateConversionProposal($this->db, $updateProposalListArr, $whereArr);
    ...
    public function getGeneratedProposalList() 
    {
        ...
        $proposal_list = $this->DeptConversionNewModel->getGeneratedProposalListData($start, $length, $order);
        ...
        if($proposal_list['total_records'] > 0){
            ...
            $link = base_url() . "index.php/DeptConversionNew/getListOfCasesByProposalId?proposal_no=".$row->id;
            $view_case = "<a href=".$link." class='btn btn-sm btn-warning' target='_caseListDetails'><i class='fa fa-edit'></i> &nbsp;Case List</a>";

           
            $link2 = base_url() . "index.php/DeptConversionNew/downloadConversionCaseReport?proposal_no=".$row->id;
    ...
    public function getAllCasesUnderProposalId() 
    {
        ...
        $cases_list = $this->DeptConversionNewModel->getAllCaseListbyProposalId($this->db,$start, $length, $order,$proposalId,$dist_code);
    ...
    public function sendConversionProposalToSec()
    {
        ...
        } else 
        {
            ...
            $designation = $this->session->userdata('designation');
                ...
                $case_list = $this->DeptConversionNewModel->getAllCasesByProposalId($this->db,$proposalNo);
                ...
                if (!empty($case_list_result)) 
                    {
                        foreach ($case_list_result as $caseN) 
                        {
                            ...
                            $updateProposalList = $this->DeptConversionNewModel->updateProposalList($this->db,$updateArrPropList,$whereArrPropList);
    ...
    public function downloadConversionCaseReport()
    {
        ...
        $case_details = $this->DeptConversionNewModel->getAllCasesByProposalId($this->db,$proposal_no)->result();
    ...
    public function downloadCaseReportByProposal()
    {
        ...
        foreach ($case_details as $details) {
            ...
            $this->db2 = $this->dbswitch2($district);
                    ...
                    $main_array[] = $case_no;
                    $landdetails = $this->DeptConversionNewModel->getLandDetails($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code, $petition_basic->mouza_pargona_code, $petition_basic->lot_no, $petition_basic->vill_townprt_code, $petition_basic->petition_no)->row();

                    // $applicants   = $this->DeptConversionNewModel->getAllApplicantBuyersName($this->db2,$case_no)->result();
                    $applicants = $this->DeptConversionNewModel->getPattadardetails($this->db2,$petition_basic->dist_code, $petition_basic->subdiv_code, $petition_basic->cir_code, $petition_basic->mouza_pargona_code, $petition_basic->lot_no, $petition_basic->vill_townprt_code, $petition_basic->petition_no, $landdetails->dag_no, $landdetails->patta_no, $landdetails->patta_type_code)->result();
                    ...
                    // $sdlacStatus = $this->DeptConversionNewModel->sdlacCaseStatus($case_no)->row();

                    // $settlement_enc = $this->DeptConversionNewModel->getSettlementEncroacher($case_no);

                    // $landless = $this->DeptConversionNewModel->getLandLessVerify($case_no)->row();

                    // $geo_tag = $this->DeptConversionNewModel->getGeoTag($case_no);
    ...
    public function verifyCasesByAssistant()
    {
        ...
        $checkVerification = $this->DeptConversionNewModel->checkCaseVerificationByAsst($this->db,$case_no)->num_rows();
    ...
    public function getAstRemarksDetailsRevertedCases() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $cabIdList = $this->DeptConversionNewModel->getAllConversionCabList($dist_code, $user_code);
            ...
            $this->db2 = $this->dbswitch2($dist_code);
            $revertedCases = $this->DeptConversionNewModel->getCaseDetailsToBeReverted($this->db2, $commaSeparatedCases)->result();
    ...
    public function revertConversionCasesFromProposal()
    {
        ...
        foreach ($allSelectedList as $caseN) 
        {
            ...
            $caseDetailsProposal = $this->DeptConversionNewModel->getCaseDetailsFromProposalList($this->db, $case_no)->result();
            ...
            $updatePetBasicStatus = $this->DeptConversionNewModel->updatePetitionBasicForConversion($this->db2, $updateData, $whereData);
