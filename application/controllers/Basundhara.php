<?php
class Basundhara extends MY_Controller
{
    ...
    function request($service)
    {
        ...
        $settlement['pending'] = $this->basundharamodel->getDepartmentRequest($service, $dist_list);
    ...
    function deptApprovedCases($service)
    {
        //var_dump($_SESSION);
        $this->load->model('basundhara/basundharamodel');
        $settlement['pending'] = $this->basundharamodel->alldepartmentApprovedCases($service);
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($dist_code == '' and $caseNo == ''  and $applicationNo == '' and $serviceType == '' and $appStatus == '' and $pendingOffice == '' and $fromDate == '' and $toDate == '' and $cir_code == '') {
                ...
                if ($caseNo != '') {
                    ...
                    $cases = $this->basundharamodel->getCasesByCaseNo($caseNo);
                    ...
                    $cases = $this->basundharamodel->getCasesByApplicationNo($applicationNo);
                    $data['cases']      = $cases->result();
                    $data['casesCount'] = $cases->num_rows();
                    ...
                    if ($fromDate != '' and $toDate != '') {
                        ...
                        $cases = $this->basundharamodel->getCasesByRespectedDataWithDateRage($serviceType, $appStatus, $pendingOffice, $fromDate, $toDate, $cir_code);
                        ...
                        $cases = $this->basundharamodel->getCasesByRespectedData($serviceType, $appStatus, $pendingOffice, $fromDate, $toDate, $cir_code);
    ...
    public function searchProposalWIthData()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $proposals = $this->basundharamodel->getProposalsByRespectedData($serviceType, $caseNo);
    ...
    public function vlbEncroacherDetails()
    {
        if (isset($_GET['dag']) && isset($_GET['m']) && isset($_GET['l']) && isset($_GET['v']) && isset($_GET['dist']) && isset($_GET['cir']) && isset($_GET['sub_div'])) {
            ...
            $vlb_encroacher = $this->basundharamodel->getEncroacherDetails($dist_code, $subdiv_code, $circle_code, $mouza_code, $lot_no, $vill_townprt_code, $dag_no);
            $vlb_enc['vlb_enc'] = $vlb_encroacher;
            if ($vlb_encroacher == true) {
                // getting the encroacher details
                $vlb_encroacher_in_dag = $this->basundharamodel->getEncroacherInDag($vlb_encroacher->id);
    ...
    public function getAllApplicationUnderProposalDept()
    {
        ...
        $pendingCase = $this->basundharamodel->getAllCasesUnderProposalDept($proposal_no, $dist_code);

        $remainingCase = $this->basundharamodel->getRemainingCasesUnderProposalDept($proposal_no, $dist_code);
    ...
    public function searchProposalIdByAppCaseNo()
    {
        ...
        if (trim($this->input->post('caseNo')) != null or trim($this->input->post('caseNo')) != '') {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $countApplicationDetails = $this->basundharamodel->countApplicationDetailsByAppNo($app_no);
                ...
                $getApplicationDetails = $this->basundharamodel->getApplicationDetailsByAppNo($app_no);
        ...
        $countCaseIdSdlacProposal = $this->basundharamodel->countProposalIdByCaseNo($case_no);
        ...
        $getSdlacProposalID = $this->basundharamodel->getProposalIdByCaseNo($case_no);
    ...
    public function getAllProposalListUnderSdlac()
    {
        if ($this->session->userdata('designation') == SDLAC_USERCODE) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->db2 =  $this->dbswitch2($dist_code);
                $proposals = $this->basundharamodel->getSdlacProposalsByService($serviceType, $sdlac_user_code);
                $data['proposals']  = $proposals->result();
                $data['proposalsCount'] = $proposals->num_rows();
                $data['_view'] = 'SettlementView/Sdlac/ProposalSearchPageSdlac';
                $this->load->view('layouts/main', $data);
    ...
    public function viewAllApplicationUnderProposalSdlac()
    {
        ...
        $pendingCase = $this->basundharamodel->getAllCasesUnderProposalSdlac($proposal_no, $dist_code);
    ...
    public function agreeProposalBySdlac()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($proposal_no != NULL && $dist_code != NULL && $service_code != NULL && $sdlac_user_code != NULL) {
                ...
                $updateSdlacMemberReportStatus = $this->basundharamodel->updateSettlementSdlacMemberReport($proposal_no, $dist_code, $service_code, $sdlac_user_code, $updateData);
                log_message('error', $this->db2->last_query());
                ...
                $updateProposalListQuery = $this->basundharamodel->updateSettlementProposalList($proposal_no, $dist_code, $service_code, $updateProposalList);
   ...
   public function loginSdlacWithoutAdhaar(){
    ...
    public function getAllSdlacProposalMeeting()
    {
        if ($this->session->userdata('designation') == SDLAC_USERCODE) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $proposals = $this->basundharamodel->getSdlacProposalsMeetingByService($dist_code,$serviceType, $sdlac_user_code);
    ...
    public function searchCasesSdlac()
    {
        ...
        $this->db2 =  $this->dbswitch2($dist_code);
        $circles = $this->basundharamodel->getcirclebyDistCode($dist_code);
    ...
    public function getCirCodeJson($dist_code)
    {
        ...
        $data = $this->basundharamodel->getCirCodeJSON($dist_code);
        $json = array();
    ...
    public function viewSdlacCaseLIst()
    {
        ...
        $this->db2 =  $this->dbswitch2($dist_code);
        $results = $this->basundharamodel->viewSdlacSearchData($start, $length, $order, $searchByCol_0,$cir_code,$serviceType,$appStatus,$caseNo,$applicationNo,$pendingOffice,$fromDate,$toDate);
    ...
    public function getAllProposalListUnderSdlacOnlineOffline()
    {
        if ($this->session->userdata('designation') == SDLAC_USERCODE) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $this->db2 =  $this->dbswitch2($dist_code);
                $proposals = $this->basundharamodel->getSdlacProposalsByServiceOnlineOffline($serviceType, $sdlac_user_code);
                $data['proposals']  = $proposals->result();
    ...
    public function getMeetingListByDistrict()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $meetings = $this->basundharamodel->getMeetingsByDistrict();
    ...
    public function getAllProposalsUnderDept()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            $proposal = $this->basundharamodel->getProposalsByMeeting($meeting_id);
    ...
    public function getAllCasesUnderProposalDept()
    {
        ...
        $pendingCase = $this->basundharamodel->getAllCasesUnderProposal($proposal_no);
    ...
    public function downloadCasesWithProposalId()
    {
        ...
        $this->basundharamodel->downloadExcelReport($file_name, $data);
    }
    ...
    public function checkListForAllotment()
    {
        ...
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            $settlement['settlement_basic'] = $this->basundharamodel->getSettlementBasic($case_no);
            $settlement['settlement_enc'] = $this->basundharamodel->getSettlementEncroacher($case_no);
            $settlement['proceedings']   = $this->basundharamodel->getSettlementProceeding($case_no);
            $settlement['roadside_reservation']   = $this->basundharamodel->getSettlementRoadsideReservation($case_no);
            $settlement['family_reservation']   = $this->basundharamodel->getSettlementFamilyReservation($case_no);
            $settlement['settlement_applicant']  = $this->basundharamodel->getSettlementApplicant($case_no);
            ...
            $settlement['settlement_dag_area'] = $this->basundharamodel->getSettlementDagArea($case_no);
            $settlement['trace_map'] = $this->basundharamodel->getTraceMap($case_no);
            $settlement['field_report'] = $this->basundharamodel->getFieldReport($case_no);
            $settlement['geo_tag'] = $this->basundharamodel->getGeoTag($case_no);
            $settlement['settlement_ap_lmnote'] = $this->basundharamodel->getSettlementLmNote($case_no);
            $settlement['applicants_buyers']   = $this->basundharamodel->getAllApplicantBuyers($case_no);
    ...
    public function verifyCaseByAssistant()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $caseCount = $this->basundharamodel->countSettlementApplicationDetailsByCaseNo($case_no, $dist_code);
            ...
            if ($caseCount == 0) {
                ...
                $this->db2->trans_begin();
                if ($this->basundharamodel->updateSettlementBasicForCab($this->db2,$case_no, $dist_code, $updateData) == 0) {
                    $this->db2->trans_rollback();
                    echo json_encode(array(
                        'responseType' => 1,
    ...
    public function viewAllCabinetCaseList()
    {
        ...
        $results = $this->basundharamodel->viewCabinetCaseList($start, $length, $order, $dist_code);
    ...
    public function downloadRecommendedCaseReportByDist()
    {
        ...
        if (!empty($allSelectedList)) {
            foreach ($allSelectedList as $row) {
                ...
                $settlement_basic = $this->basundharamodel->getSettlementBasic($case_no);

                $applicants   = $this->basundharamodel->getAllApplicantBuyersName($case_no)->result();
                ...
                $dags = $this->basundharamodel->getAllAppliedDags($case_no)->result();
                ...
                $sdlacStatus = $this->basundharamodel->sdlacCaseStatus($case_no)->row();

                $settlement_enc = $this->basundharamodel->getSettlementEncroacher($case_no);
                ...
                $landless = $this->basundharamodel->getLandLessVerify($case_no)->row();

                $geo_tag = $this->basundharamodel->getGeoTag($case_no);
        ...
        $this->basundharamodel->downloadExcelReport($file_name, $finalArray);
    }
    ...
    public function viewAllCasesUnderProposalDept()
    {
        ...
        $results = $this->basundharamodel->getAllCasesUnderProposal2($start, $length, $order, $dist_code);
    ...
    public function getAllCasesListByDept()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            $data['user_dist']      = $this->basundharamodel->getDeptUserDistListWithCaseCount();
            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                $data['casesCount'] = 0;
                $this->session->set_flashdata('message', 'Please Select District Before Proceed.');
                $data['_view'] = 'SettlementView/Dept/AllPendingCaseListUnderDpt';
                $this->load->view('layouts/main', $data);
            } else {

                $this->db2 =  $this->dbswitch2($dist_code);
                $meeting = $this->basundharamodel->getMeetingListByDist($this->db2,$dist_code);
                ...
                log_message('error','--'.$this->db->last_query());
                $cabIdList = $this->basundharamodel->getCabinetIdList($dist_code,$user_code)->result();
    ...
    public function addCasesToCabMemo_Old()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            foreach ($allSelectedList as $item) {
                ...
                $cabMemoCases = $this->basundharamodel->getExistingCasesUnderCabMemo($dist_code);
                ...
                if(CHITHA_AREA_VALIDATION == 1)
                {
                    ...
                    {
                        $checkArea = $this->basundharamodel->chithaReserveAreaCheckWithCaseNo($this->db2,$case); 
                ...
                $pullRequestCase = $this->basundharamodel->getPullRequestStatus($this->db2,$casesList);
                ...
                if (!empty($allSelectedList)) {
                    ...
                    foreach ($allSelectedList as $row) {
                        ...
                        if ($insertCabList != TRUE) {
                            ...
                            $updateCabIdList = $this->basundharamodel->updateCabStatus($this->db,$where, $updateData);
    ...
    public function downloadReportForCabMemo()
    {
        ...
        $dist_codes = $this->basundharamodel->getDistrictUnderCabMemo($this->db,$cab_memo_id)->result();
        ...
        foreach ($dist_codes as $dist) {
            $allSelectedList = $this->basundharamodel->getCasesUnderCabMemo($this->db,$cab_memo_id, $dist)->result();
    ...
    public function clearCaseData(){
        ...
        foreach($district as $dist)
        {
            ...
            $allSelectedList = $this->basundharamodel->getCasesUnderDistCabMemo($district)->result();
            // Switch DB based on dist_code
            $this->db2 = $this->dbswitch2($district);
            ...
            if (!empty($allSelectedList)) {
                foreach ($allSelectedList as $row) {
                    ...
                    $update_basic = $this->basundharamodel->clearBasicData($where, $updateData);
                }
            }
        }
    ...
    $clearCabDetails = $this->basundharamodel->clearCabDetails();
  ...
  public function getAllCasesUnderDept() {
    ...
    $cases_list = $this->basundharamodel->getAllCasesUnderDepartmentAll($this->db2,$start, $length, $order,$service_code,$meeting_no,$verification,$pullRequest);
    ...
    $cases_list = $this->basundharamodel->getAllCasesUnderAssistant($this->db2,$start, $length, $order,$service_code,$meeting_no);
            ...
            $user_code = $this->session->userdata('user_code');
                ...
                if (!empty($allSelectedList)) {
                    ...
                    foreach ($allSelectedList as $row) {
                        ...
                        $this->db2->trans_begin();
                        $checkCasesSendStatus = $this->basundharamodel->checkCaseStatusVerify($case_no, $dist_code);
    ...
    public function casesListForFinalApprovalByDept()
    {
        ...
        $user_code   = $this->session->userdata('user_code');
        $this->db = $this->load->database('db2', TRUE);
        $cases_list = $this->basundharamodel->getAllCasesFromMemoForFinalApproval($this->db,$cab_id,$user_code);

        $digitalSignedStatus = $this->basundharamodel->digitalSignedStatusOfCabId($this->db,$cab_id);
    ...
    public function revertToDcByDeptTemp()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $updateBasicStatus = $this->basundharamodel->updateSettlementBasicData($case_no, $updateBasicData);
            ...
            //////proceeding start//////
                ...
                $insertProceeding = $this->db2->insert('settlement_proceeding', $insPetProceed);
                    ...
                    if ($insertProceeding != 1) {
                        ...
                        $updateProposalRevert = $this->basundharamodel->updateProposalData($case_no, $updateProposalData);
                                    ...
                                    // var_dump($rtps_status);
                                     ...
                                     if (trim($rtps_status) != 'y') {
                                        ...
                                        $this->db = $this->load->database('db2', TRUE);
                                            ...
                                            $updateCabMemoList = $this->basundharamodel->updateCabMemoList($updateData, $where);
    ...
    public function finalSubmissionByDept()
    {
            ...
            } else 
            {
                ...
                $this->db = $this->load->database('db2', TRUE);
                $dist_codes = $this->basundharamodel->getDistrictUnderCabMemo($this->db,$cabinet_id)->result();
                ...
                if($errCheck == 0)
                {
                    ...
                    {
                        $this->db = $this->load->database('db2', TRUE);
                        $caseListForFinalSubmitByDist = $this->basundharamodel->getCaseListDetailsForFinalSubmit($this->db,$cabinet_id,$user_code,$dist->dist_code)->result();
                    ...
                    $affectedRows = $this->basundharamodel->updateCabStatus($this->db,$whereUpload, $updateUpload);
                    if($affectedRows <= 0){
    ...
    public function getRevertedCasesDetails()
    {
        ...
        $revertedCases = $this->basundharamodel->getAllRevertedCaseDetails($cabId);
    ...
    public function getAllRevertedCasesListByDept()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            $data['user_dist']      = $this->basundharamodel->getDeptUserDistListWithRevertedCaseCount();
    ...
    $cases_list = $this->basundharamodel->getAllRevertedCasesUnderDepartmentAll($this->db2,$start, $length, $order,$service_code);
    ...
    public function downloadRevertedCaseListReport()
    {
        ...
        foreach ($distMeeting as $dist) {
            ...
            $meetingCaseReverted = $this->basundharamodel->getRevertedCasesCountByDistMeeting($this->db2,$dist->meeting_id)->result();
    ...
    public function downloadRevertedCaseListReportOnlyRemark()
    {
        ...
        $currentCabCreationDate  = $cab_id_date->created_at;
            ...
            $deptCaseReverted = $this->basundharamodel->getRevertedCasesByDptBeforeCabApproval($this->db2,$cab_finalized_date, $cab_approve_date)->result();

            // $caseListNotUnderCabMemo = $this->basundharamodel->ListOfRevertCasesNotUnderCabMemo($this->db2,$dist->dist_code,$currentCabCreationDate,$cab_id_date->id);
    ...
    public function getRemarksDetailsRevertedCases()
    {
        ...
        $this->form_validation->set_rules('district_id', 'District ID', 'trim|required|is_natural');
         ...
         if ($this->form_validation->run() == FALSE) {
            ...
            $cabIdList = $this->basundharamodel->getCabinetIdList($dist_code,$user_code)->num_rows();

            if ($cabIdList == 0)
            {
                echo json_encode(array(
                    'responseType' => 3,
                    'message' => 'Cab ID Not Created Yet...! Please Create CAB ID before Revert Cases..',
                ));
                return false;
            }
            ...
            $this->db2 =  $this->dbswitch2($dist_code);
            $revertedCases = $this->basundharamodel->getDetailsToBeRevertedCase($this->db2,$commaSeparatedCases);
            // echo json_encode($revertedCases);
        ...
        } else 
        {
            ...
            $casesArray = array_map(function ($a, $b, $c) {
                ...
                foreach($casesArray as $row)
                {
                    ...
                    //Insert Data in Cab_memo_revert_cases
                    $insRevertCases[] = [
                        'cab_id' => $cab_id_revert,
                        'case_no' => $case_no,
                        'revert_on' => date('Y-m-d h:i:s'),
                        'created_at' => date('Y-m-d h:i:s'),
                ...
                $insertRevertList = $this->db->insert_batch('cab_memo_revert_list', $insRevertCases);

                if($insertRevertList <= 0 || $this->db->affected_rows() <= 0)
                {
                    $this->db->trans_rollback();
                    log_message('error', '#ERRINSERTCABREVERT001: Insert Failed in  cab_memo_revert_list' );
                    echo json_encode(array(
                        'responseType' => 3,
                        'message'      => '#ERRINSERTCABREVERT001: Cases Not Approved ! Kindly Contact System Admin.  !!!',
                    ));
                    return false;
                }else   
                {
                    ...
                    }else
                    {
                            ...
                            }else
                            {
                                ...
                                }else
                                {
                                    ...
                                    $task   = MB_DEPARTMENT;
                                    $pen    = MB_DEPUTY_COMM;
                                    $rtps_status = $this->basundharamodel->applicationStatusUpdateBulk($concatenatedAppNo,'NA',$rmk,$status,$task,$pen);
    ...
    public function bulkApproveCasesByDPT()
    {
        ...
        } else
        {
                ...
                $caseWithDist = $this->basundharamodel->getDistrictCasesUnderCabMemo($this->db,$cabinet_id)->result();
                ...
                if($errCheck == 0)
                {
                    ...
                    $updateCabMemoStatus = $this->basundharamodel->updateCabMemoList($updateCabMemoData, $whereMemo);
                    ...
                    $updateCabIdStatus = $this->basundharamodel->updateCabStatus($this->db,$whereCabId, $updateCabIdData);
                                        ...
                                        }else
                                        {
                                            ...
                                            $updateProposalData = $this->db2->update_batch('settlement_proposal_cases',$updateProposalData,'case_no');
                                                ...
                                                else
                                                {
                                                    ...
                                                    $cabIdUpdate = $this->basundharamodel->updateCabStatus($this->db,$whereCabID, $updateCabPartial);
                                                    if($cabIdUpdate <= 0){
    ...
    public function getAllVgrCicleDistWise()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            $data['user_dist']      = $this->basundharamodel->getDeptUserDistListWithCaseCountVGR();
    ...
    public function getAllVGRCirclesByDist() 
    {
        ...
        $cases_list = $this->basundharamodel->getAllVGRCasesCircleByDist($this->db2,$start, $length, $order);
    ...
    public function getAllVGRCaseListByCircle()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            $user_code = $this->session->userdata('user_code');
            $this->db2 =  $this->dbswitch2($dist_code);
            $meeting = $this->basundharamodel->getMeetingListByDistVGR($this->db2,$dist_code);
            $data['meetingList']      = $meeting->result();
            ...
            $data['ast_list'] = $this->db->query("SELECT name,user_code,email,designation FROM depart_users WHERE designation in ('$ast','$sec')",array())->result();
            log_message('error','--'.$this->db->last_query());
            $cabIdListVGR = $this->basundharamodel->getVGRCabinetIdList($dist_code,$user_code)->result();
    ...
    public function getAllVGRCasesByCircle() 
    {
        ...
        $cases_list = $this->basundharamodel->getAllVGRCasesByCircle($this->db2,$start, $length, $order,$subdiv_code,$cir_code,$meeting_no,$verification,$pullRequest);
    ...
    public function addVGRCasesToCabMemo_old()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            foreach ($allSelectedList as $item) {
                ...
                $vgrRevertedCases = $this->basundharamodel->getRevertedCasesDetailsVGR($this->db2,$concatedCasesNo);
                ...
                //////////////VGR NEW CHITHA_AREA VALIDATION START////////////////
                    ...
                    $vgrReservationCases = $this->basundharamodel->getSettlementVgrReservationDetails($this->db2,$concatedCasesNo);
                    ...
                    else
                    {
                        ...
                        foreach($vgrReservationCasesList as $vgrReservation)
                        {
                            ...
                            $checkReserv = $this->basundharamodel->getTotalVgrReservationInDag($this->db2,$vgrReservation['dist_code'], $vgrReservation['subdiv_code'], $vgrReservation['cir_code'], $vgrReservation['mouza_pargona_code'], $vgrReservation['lot_no'], $vgrReservation['vill_townprt_code'], $vgrReservation['dag_no']);
                ...
                if(VGR_CLUSTER_VALIDATION == 1)
                    {
                        ...
                        {
                            $case_no = trim($case);
                            $CheckClusterCount = $this->basundharamodel->checkIfCaseRevertedFromCluster($this->db2,$case_no); 
    ...
    public function downloadRevertedCaseListReportVGR()
    {
        ...
        $previousCabApprovedDate  = $cab_id_date->updated_at;
            ...
            $deptCaseReverted = $this->basundharamodel->getVGRRevertedCasesByDptBeforeCabApproval($this->db2,$cab_finalized_date, $cab_approve_date)->result();

            // $caseListNotUnderCabMemo = $this->basundharamodel->ListOfVGRRevertCasesNotUnderCabMemo($this->db2,$dist->dist_code,$previousCabApprovedDate,$cab_id_date->id);
    ...
    public function casesListForFinalApprovalByDeptVGR()
    {
        ...
        $user_code   = $this->session->userdata('user_code');
        $this->db = $this->load->database('db2', TRUE);
        $cases_list = $this->basundharamodel->getAllVGRCasesFromMemoForFinalApproval($this->db,$cab_id,$user_code);
    ...
    public function getAllRevertedCasesListByDeptVGR()
    {
        if ($this->session->userdata('designation') == DEPARTMENT_USERCODE) {
            ...
            $data['user_dist']      = $this->basundharamodel->getDeptUserDistListWithRevertedCaseCountVGR();
    ...
    public function getAllRevertedCasesUnderDeptVGR() 
    {
        ...
        $cases_list = $this->basundharamodel->getAllRevertedCasesUnderDepartmentVGR($this->db2,$start, $length, $order,$service_code);
        ...
        } else
        {
                ...
                if(VGR_CLUSTER_VALIDATION == 1)
                {
                    ...
                    foreach($caseWithDist as $caseDist)
                    {
                        ...
                        $CheckClusterCount = $this->basundharamodel->checkIfCaseRevertedFromCluster($this->db2,$vgr_case_no); 
                ...
                foreach($distMeeting as $dist)
                {
                    ...
                    $meetingCaseRevert = $this->basundharamodel->getMeetingCasesExistInVgrRevert($this->db2,$dist->meeting_id);
                                ...
                                foreach($dist_codes as $dist)
                                {
                                    ...
                                    if (!empty($caseListForFinalSubmitByDist)) 
                                    {
                                        ...
                                        foreach ($caseListForFinalSubmitByDist as $row) 
                                        {
                                            ...
                                            $clusterId = $this->basundharamodel->getClusterIdByCaseNo($this->db2,$case_no);
        ...
        } else 
        {
            ...
            if($errCheck == 0)
            {
                ...
                foreach($casesArray as $row)
                {
                    ...
                    $getBasicData = $this->basundharamodel->getBasicCasesDetailsVGR($this->db2,$case_no)->row();
                        ...
                        if (!empty($allSelectedList)) 
                            {
                                ...
                                if (!empty($duplicates)) 
                                {
                                    ...
                                    $this->db2 =  $this->dbswitch2($dist_code);
                                    $checkPullRequestFinalStatus = $this->basundharamodel->checkPullRequestFinalStatus($this->db2,$duplicateCases)->result();
                                        ...
                                        foreach($casesExist as $casesE)
                                            {
                                                ...
                                                $this->db = $this->load->database('db2', TRUE);
                                                $getOldCaseDetails = $this->basundharamodel->getOldCaseDetailsFromCabMemo($this->db,$caseNoOld,$dist_code)->row();

                                                $oldCaseNo = $getOldCaseDetails->case_no;

                                                $this->db2 =  $this->dbswitch2($dist_code);
                                                $getMeetingProposal = $this->basundharamodel->getMeetingProposalByCaseNo($this->db2,$caseNoOld)->row();
                                                    ...
                                                    $caseBackupDetails = [
                                                        ...
                                                        {
                                                            $updateCabMemoList = $this->basundharamodel->updateCabMemoList($newCaseDetails,$whereCase);
                                                            ...
                                                            if ($updateCabMemoList <= 0) {
                                                                ...
                                                                $updateCabIdListStatus = $this->basundharamodel->updateCabStatus($this->db,$whereCabId, $updateCabIdData);
                                                                ...
                                                                return false;
                                                                    ...
                                                                    $updateBasicStatusOld = $this->basundharamodel->updateSettlementBasicForCab($this->db2,$oldCaseNo, $dist_code, $updateBasicData);
                                ...
                                if (!empty($newCases)) 
                                {
                                    foreach ($newCases as $caseN) 
                                    {
                                        ...
                                        $this->db2 =  $this->dbswitch2($dist_code);
                                        $getMeetingProposal = $this->basundharamodel->getMeetingProposalByCaseNo($this->db2,$case_no)->row();
                                        ...
                                        if ($insertCabList != TRUE) {
                                            ...
                                            if ($updateCabIdList <= 0) {
                                                ...
                                                $updateBasicStatusNew = $this->basundharamodel->updateSettlementBasicForCab($this->db2,$case_no, $dist_code, $updateData);
