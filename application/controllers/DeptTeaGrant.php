<?php
class DeptTeaGrant extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('TeaGrant/DeptTeaGrantModel');
        $this->db2 = NULL;
    }
    ...
    public function teaGrantLanding()
    {
    ...
    public function viewTeaGrantCases()
    {
        ...
        //$data['teaGrantCaseList'] = $this->DeptTeaGrantModel->getTeaGrantCaseList($this->db2,$dist_code);
        $data['status'] = true;
        $this->load->view('tea_grant/tea_grant_case_list',$data);
	}
    
    public function getPendingTeaGrantCaseList() 
    {
        $json = null;
        ...
        $this->db2 =  $this->dbswitch2($dist_code);
        $case_list = $this->DeptTeaGrantModel->getPendingCaseListDetails($this->db2,$start, $length, $order,$dist_code,$searchByCol_0);
        ...
        if($case_list['total_records'] >  0){
            ...
            foreach($data_rows as $row) {
                ...
                if($ast_verification == 'A'){
                    ...
                    $url = base_url('DeptTeaGrant/viewAssistantVerificationDetails');
                    $url .= '?dist_code=' . urlencode($row->dist_code);
                    $url .= '&case_no=' . urlencode($row->case_no);
    ...
    public function teaGrantCaseDetails_old()
    {
        $dist_code = $this->input->get('dist_code');
        $application_no = $this->input->get('case_no');
        $this->db2 =  $this->dbswitch2($dist_code);
        $basic = $this->DeptTeaGrantModel->getSettlementBasic($this->db2,$application_no);
        $applicants_buyers = $this->DeptTeaGrantModel->getAllApplicantBuyers($this->db2,$application_no);
        $applicants_owners = $this->DeptTeaGrantModel->getAllApplicantOwners($this->db2,$application_no);
        $applicants_dag_details= $this->DeptTeaGrantModel->getAllApplicantDagDetails($this->db2,$application_no);
        
        $adcdata           = [];
        $dags              = $this->DeptTeaGrantModel->getSettlementDag($this->db2,$application_no);
        $lmnotes           = $this->DeptTeaGrantModel->getSettlementTenantLmNote($this->db2,$application_no);
        $proceedings       = $this->DeptTeaGrantModel->getSettlementProceeding($this->db2,$application_no);
        $dhardocuments     = $this->DeptTeaGrantModel->getDocuments($this->db2,$application_no);
        $nominee           = $this->DeptTeaGrantModel->getAllNomineeDetail($this->db2,$application_no);
        $existing_pattadar = $this->DeptTeaGrantModel->getAllExistingPattadar($this->db2,$application_no);
        $deed_applicant    = $this->DeptTeaGrantModel->getAllDeedPattadar($this->db2,$application_no);
        $family_tree       = $this->DeptTeaGrantModel->getAllFamilyTree($this->db2,$application_no);
        ...
        $premium_data = $this->DeptTeaGrantModel->getPremium($this->db2,$application_no);
        ...
        $data['deleted_dags']           = $this->DeptTeaGrantModel->getDeletedDags($this->db2,$application_no);
        ...
        $caseDetails = $this->DeptTeaGrantModel->getSettlementApplicationDetailsByCaseNo($this->db2,$case_no,$dist_code);
        $proceedings = $this->DeptTeaGrantModel->getSettlementProceeding($this->db2,$case_no);
        
        $data['caseCount']   = $caseCount;
        $data['caseDetails'] = $caseDetails;
        $data['proceedings'] = $proceedings;
        
        $data['reservation'] = $this->DeptTeaGrantModel->getSettlementReservation($this->db2,$application_no);
        $data['additional_property'] = $this->DeptTeaGrantModel->getAdditionalProperty($this->db2,$application_no);
        $data['_view'] = 'tea_grant/case_view';
        $this->load->view('layouts/main', $data);
      
    }

    public function teaGrantCaseDetails()
    {
        $dist_code = $this->input->get('dist_code');
        $application_no = $this->input->get('case_no');
        $this->db2 =  $this->dbswitch2($dist_code);
    ...
    //added by HRP 06-01-25
    public function sentTeaGrantCasesForVerification()
    {
            ...
            if (!empty($allSelectedList)) 
                {
                    foreach ($allSelectedList as $caseN) 
                    {
                        ...
                        $updateSetlmntBasicStatus = $this->DeptTeaGrantModel->updateSettlementBasicForCab($this->db2,$case_no, $dist_code, $updateData,$insSetProceed);
    ...
    public function viewTeaGrantCasesDptAsst()
    {
        $dist_code   = $this->input->post('dist_code');
        $data = array();
        $data['dist_code'] =$dist_code;
        ...
        $this->db2 =  $this->dbswitch2($dist_code);
        $data['status'] = true;
        $this->load->view('tea_grant/case_list_pending_under_asst',$data);
	}

    public function getPendingTeaGrantCaseListUnderAssistant() 
    {
        ...
        $case_list = $this->DeptTeaGrantModel->getPendingCaseListDetailsForVerificationAsst($this->db2,$start, $length, $order,$dist_code,$searchByCol_0);
    ...
    public function sentTeaGrantCasesFromASOtoJS()
    {
        $_POST = json_decode(file_get_contents("php://input"), true);
    ...
    public function viewAssistantVerificationDetails()
    {
        ...
        $assistantVerification=$this->DeptTeaGrantModel->getAssistantVerificationDetails($this->db,$case_no)->result();
        $data['assistantVerification'] = $assistantVerification;
        $data['case_no'] = $case_no;
        $data['_view'] = 'tea_grant/assitantVerificationDetails.php';
        $this->load->view('layouts/main', $data);
