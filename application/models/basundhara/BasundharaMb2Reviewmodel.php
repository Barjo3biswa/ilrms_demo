<?php
class BasundharaMb2Reviewmodel extends CI_Model
{
    ...
    public function getMeetingListByDist($dbb,$dist_code)
    {
        ...
        $sql = "select distinct ml.id,ml.meeting_name from proposal_meeting_list ml 
                    ...
                    and review_flag=1  and sb.service_code in ('13','14','15','16','18','17') and ml.digital_sign_status =? and sb.from_office = ? and sb.cab_memo_prepared =? ";
    ...
    public function getAllCasesFromMemoForFinalApproval($dbb,$cab_id,$user_code)
    {
        ...
        $sql = "select * from cab_memo_list where cab_id =? and user_code =?  and final_submit_status=? order by id";
        $data  = $dbb->query($sql, array($cab_id,$user_code,$final_submit_status));
        return $data;
    }
